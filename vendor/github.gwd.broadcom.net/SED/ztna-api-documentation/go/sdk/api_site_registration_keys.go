...
type SiteRegistrationKeysApiService service
/*
SiteRegistrationKeysApiService Clean Site Registration Keys
Cleans the site&#x27;s registration keys list.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId Site ID.

*/
func (a *SiteRegistrationKeysApiService) DeleteSiteRegistrationKeys(ctx context.Context, siteId string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/sites/{site-id}/registration_keys"
...
/*
SiteRegistrationKeysApiService List Site Registration Keys
Returns the site&#x27;s registration keys list.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId Site ID.
@return SiteRegistrationKeysResponse
*/
func (a *SiteRegistrationKeysApiService) GetSiteRegistrationKeys(ctx context.Context, siteId string) (SiteRegistrationKeysResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue SiteRegistrationKeysResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v SiteRegistrationKeysResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
...
/*
SiteRegistrationKeysApiService Rotate Site Registration Keys
Rotates the site&#x27;s registration keys.&lt;br /&gt; If no registration key exists, the first request generates one.&lt;br /&gt; Future rotation requests replace the primary key.&lt;br /&gt; 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId Site ID.
 * @param optional nil or *SiteRegistrationKeysApiRotateSiteRegistrationKeysOpts - Optional Parameters:
     * @param "Body" (optional.Interface of SiteidRegistrationKeysBody) - 
@return RotateKeyResponse
*/

type SiteRegistrationKeysApiRotateSiteRegistrationKeysOpts struct {
    Body optional.Interface
}

func (a *SiteRegistrationKeysApiService) RotateSiteRegistrationKeys(ctx context.Context, siteId string, localVarOptionals *SiteRegistrationKeysApiRotateSiteRegistrationKeysOpts) (RotateKeyResponse, *http.Response, error) {
	var (
