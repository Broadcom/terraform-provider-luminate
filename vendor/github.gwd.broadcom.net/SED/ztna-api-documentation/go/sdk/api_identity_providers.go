...
Return an array of JSON objects. Each object represents an Identity Provider configuration in your Symantec ZTNA tenant. &lt;br&gt; 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *IdentityProvidersApiListIdentityProvidersOpts - Optional Parameters:
     * @param "IncludeLocal" (optional.Bool) -  Indication whether to include Symantec ZTNA internal Identity Provider in the response. 
