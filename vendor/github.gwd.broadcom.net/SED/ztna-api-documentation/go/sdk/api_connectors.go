...
/*
ConnectorsApiService Create Connector
Creates a Connector in your Symantec ZTNA tenant. To complete configuring the Symantec ZTNA connector, you should retrieve the deployment command using &lt;a href&#x3D;\&quot;#operation/Get the Connector Deployment Command\&quot;&gt;Connector Deployment Command API&lt;/a&gt; and execute it on the target machine. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param bindToSiteId The ID of the site that should contain this connector.
 * @param optional nil or *ConnectorsApiCreateAConnectorOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ConnectorsBody) - 
@return Connector
*/

type ConnectorsApiCreateAConnectorOpts struct {
    Body optional.Interface
}

func (a *ConnectorsApiService) CreateAConnector(ctx context.Context, bindToSiteId string, localVarOptionals *ConnectorsApiCreateAConnectorOpts) (Connector, *http.Response, error) {
	var (
...
Delete the connector from the contained site in your Symantec ZTNA tenant. &lt;br&gt; In order to complete the action the connector container that runs in the corresponding datacenter should be removed. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param connectorId Connector ID.

*/
func (a *ConnectorsApiService) DeleteAConnector(ctx context.Context, connectorId string) (*http.Response, error) {
	var (
...
@return Connector
*/
func (a *ConnectorsApiService) GetAConnector(ctx context.Context, connectorId string) (Connector, *http.Response, error) {
	var (
...
type ConnectorsApiGetAllConnectorsOpts struct {
...
func (a *ConnectorsApiService) GetAllConnectors(ctx context.Context, localVarOptionals *ConnectorsApiGetAllConnectorsOpts) (ConnectorsPage, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ConnectorsApiService) GetEnvironmentVariablesForConnectorDeployment(ctx context.Context, connectorId string) (ConnectorEnvironmentVariables, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ConnectorsApiService) GetTheConnectorDeploymentCommand(ctx context.Context, connectorId string) (ConnectorDeploymentCommand, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ConnectorsApiService) GetTheLatestConnectorVersion(ctx context.Context) (ConnectorVersion, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
