...
type DNSResiliencyApiService service
/*
DNSResiliencyApiService Create New DNS Group
Create New DNS Group.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
@return DnsGroupOutput
*/
func (a *DNSResiliencyApiService) CreateADNSGroup(ctx context.Context, body WssintegrationtenantDnsgroupsBody) (DnsGroupOutput, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue DnsGroupOutput
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/wss-integration-tenant/dns-groups"
...
/*
DNSResiliencyApiService Create New DNS Server in Group
Create New DNS Server in Group.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param dnsGroupId The ID of the group to create a server for.
@return DnsServerOutput
*/
func (a *DNSResiliencyApiService) CreateADNSServer(ctx context.Context, body DnsGroupIdServersBody, dnsGroupId string) (DnsServerOutput, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue DnsServerOutput
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/wss-integration-tenant/dns-groups/{dnsGroupId}/servers/"
	localVarPath = strings.Replace(localVarPath, "{"+"dnsGroupId"+"}", fmt.Sprintf("%v", dnsGroupId), -1)
...
/*
DNSResiliencyApiService Delete a group by ID
Delete a group by ID.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param dnsGroupId The ID of the group to retrieve, update or delete.

*/
func (a *DNSResiliencyApiService) DeleteADNSGroup(ctx context.Context, dnsGroupId string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/wss-integration-tenant/dns-groups/{dnsGroupId}"
	localVarPath = strings.Replace(localVarPath, "{"+"dnsGroupId"+"}", fmt.Sprintf("%v", dnsGroupId), -1)
...
/*
DNSResiliencyApiService Delete DNS Servers By Ids
Delete DNS server by group id and dns server ids.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param dnsGroupId The ID of the DNS resiliency group.

*/
func (a *DNSResiliencyApiService) DeleteDNSServers(ctx context.Context, body ServersDeletebyidsBody, dnsGroupId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/wss-integration-tenant/dns-groups/{dnsGroupId}/servers/delete-by-ids"
	localVarPath = strings.Replace(localVarPath, "{"+"dnsGroupId"+"}", fmt.Sprintf("%v", dnsGroupId), -1)
...
/*
DNSResiliencyApiService Enable/Disable DNS Groups
Enable or Disable DNS Groups. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body

*/
func (a *DNSResiliencyApiService) EnableOrDisableDNSGroups(ctx context.Context, body DnsgroupsEnableByIdsBody) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/wss-integration-tenant/dns-groups/enableByIds"
...
/*
DNSResiliencyApiService Get DNS Group By ID
Retrieve a group by its ID.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param dnsGroupId The ID of the group to retrieve, update or delete.
@return DnsGroupOutput
*/
func (a *DNSResiliencyApiService) GetADNSGroup(ctx context.Context, dnsGroupId string) (DnsGroupOutput, *http.Response, error) {
	var (
...
/*
DNSResiliencyApiService Get DNS Server By Id
Retrieve a server of a specific group by id.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param dnsGroupId The ID of the group to get the server for.
 * @param serverId The ID of the DNS server to retrieve.
@return DnsServerOutput
*/
func (a *DNSResiliencyApiService) GetADNSServer(ctx context.Context, dnsGroupId string, serverId string) (DnsServerOutput, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/wss-integration-tenant/dns-groups/{dnsGroupId}/servers/{serverId}"
	localVarPath = strings.Replace(localVarPath, "{"+"dnsGroupId"+"}", fmt.Sprintf("%v", dnsGroupId), -1)
...
/*
DNSResiliencyApiService Get All Servers Of a DNS Group
Retrieve a list of servers for a specific group.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param dnsGroupId The ID of the group to retrieve servers for.
@return []DnsServerOutput
*/
func (a *DNSResiliencyApiService) GetAllServersOfADNSGroup(ctx context.Context, dnsGroupId string) ([]DnsServerOutput, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
DNSResiliencyApiService List DNS Groups
List DNS Groups.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *DNSResiliencyApiListDNSGroupsOpts - Optional Parameters:
...
@return DnsGroupOutputPage
*/

type DNSResiliencyApiListDNSGroupsOpts struct {
...
func (a *DNSResiliencyApiService) ListDNSGroups(ctx context.Context, localVarOptionals *DNSResiliencyApiListDNSGroupsOpts) (DnsGroupOutputPage, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue DnsGroupOutputPage
	)
...
/*
DNSResiliencyApiService Update a group by ID
...
@return DnsGroupOutput
*/
func (a *DNSResiliencyApiService) UpdateADNSGroup(ctx context.Context, body DnsgroupsDnsGroupIdBody, dnsGroupId string) (DnsGroupOutput, *http.Response, error) {
	var (
...
/*
DNSResiliencyApiService Update DNS Server By Id
Update DNS server of a specific group by id.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param dnsGroupId The ID of the DNS resiliency group.
 * @param serverId The ID of the DNS server to update.
@return DnsServerOutput
*/
func (a *DNSResiliencyApiService) UpdateADNSServer(ctx context.Context, body ServersServerIdBody, dnsGroupId string, serverId string) (DnsServerOutput, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
DNSResiliencyApiService Update DNS Servers Order
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param dnsGroupId The ID of the group of the DNS server.

*/
func (a *DNSResiliencyApiService) UpdateDNSServerResiliencyOrder(ctx context.Context, body DnsGroupIdServerorderBody, dnsGroupId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/wss-integration-tenant/dns-groups/{dnsGroupId}/server-order"
	localVarPath = strings.Replace(localVarPath, "{"+"dnsGroupId"+"}", fmt.Sprintf("%v", dnsGroupId), -1)
