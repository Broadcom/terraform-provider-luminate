...
@return Collection
*/
func (a *CollectionsApiService) CreateACollection(ctx context.Context, body CollectionBody) (Collection, *http.Response, error) {
	var (
...
@return RoleBindings
*/
func (a *CollectionsApiService) CreateACollectionRoleBinding(ctx context.Context, body CollectionCollectionrolebindingsBody) (RoleBindings, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue RoleBindings
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/collection/collection-role-bindings"
...
@return RoleBindings
*/
func (a *CollectionsApiService) CreateASiteRoleBinding(ctx context.Context, body CollectionSiterolebindingsBody) (RoleBindings, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/collection/site-role-bindings"
...
@return RoleBindings
*/
func (a *CollectionsApiService) CreateATenantRoleBinding(ctx context.Context, body CollectionTenantrolebindingsBody) (RoleBindings, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/collection/tenant-role-bindings"
 ...
 * @param optional nil or *CollectionsApiDeleteACollectionOpts - Optional Parameters:
     * @param "Body" (optional.Interface of CollectionCollectionidBody1) - 

*/

type CollectionsApiDeleteACollectionOpts struct {
    Body optional.Interface
}

func (a *CollectionsApiService) DeleteACollection(ctx context.Context, collectionId string, localVarOptionals *CollectionsApiDeleteACollectionOpts) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/collection/{collection-id}"
	localVarPath = strings.Replace(localVarPath, "{"+"collection-id"+"}", fmt.Sprintf("%v", collectionId), -1)
...
Delete Collection Role Binding in your Symantec ZTNA tenant by role binding IDs. you can retrieve role bindings ids from &lt;a href&#x3D;\&quot;#operation/List Role Bindings\&quot;&gt; List Role Bindings&lt;/a&gt; API. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body

*/
func (a *CollectionsApiService) DeleteARoleBinding(ctx context.Context, body RolebindingsDeleteBody) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/collection/role-bindings/delete"
...
@return Collection
*/
func (a *CollectionsApiService) GetACollection(ctx context.Context, collectionId string) (Collection, *http.Response, error) {
	var (
...
func (a *CollectionsApiService) GetCollectionsBySite(ctx context.Context, siteId string) (CollectionIds, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CollectionIds
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/collection/site/{site-id}"
...
*/
func (a *CollectionsApiService) GetSitesLinkedToTheCollection(ctx context.Context, collectionId string) (CollectionSiteLinks, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CollectionSiteLinks
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/collection/site-links/{collection-id}"
	localVarPath = strings.Replace(localVarPath, "{"+"collection-id"+"}", fmt.Sprintf("%v", collectionId), -1)
...
@return CollectionSiteLinks
*/
func (a *CollectionsApiService) LinkASiteToACollection(ctx context.Context, body CollectionSitelinksBody) (CollectionSiteLinks, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/collection/site-links"
...
Return an array of paginated JSON objects. Each object represents an collection configured in your Symantec ZTNA tenant. &lt;br&gt; Using the query filter&#x3D;testCollection will return all the collection for which one or more of the above listed fields contain \&quot;testCollection\&quot; 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CollectionsApiListCollectionsOpts - Optional Parameters:
     ...
     * @param "Size" (optional.Float64) -  The number of items returned in a single page.
     * @param "Page" (optional.Float64) -  The page number.
     * @param "Name" (optional.String) -  The name of the resource. 
     * @param "ApplicationId" (optional.Interface of string) -  Application ID.
     * @param "SiteId" (optional.Interface of string) -  Site ID.
     * @param "PolicyId" (optional.Interface of string) -  Policy ID.
@return CollectionPage
*/

type CollectionsApiListCollectionsOpts struct {
    Sort optional.String
    Size optional.Float64
    Page optional.Float64
    Name optional.String
    ApplicationId optional.Interface
    SiteId optional.Interface
    PolicyId optional.Interface
}

func (a *CollectionsApiService) ListCollections(ctx context.Context, localVarOptionals *CollectionsApiListCollectionsOpts) (CollectionPage, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CollectionPage
	)
	...
	if localVarOptionals != nil && localVarOptionals.ApplicationId.IsSet() {
		localVarQueryParams.Add("application-id", parameterToString(localVarOptionals.ApplicationId.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.SiteId.IsSet() {
		localVarQueryParams.Add("site-id", parameterToString(localVarOptionals.SiteId.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.PolicyId.IsSet() {
		localVarQueryParams.Add("policy-id", parameterToString(localVarOptionals.PolicyId.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
/*
CollectionsApiService List Role Bindings
List Role Bindings in your Symantec ZTNA tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CollectionsApiListRoleBindingsOpts - Optional Parameters:
     * @param "Sort" (optional.Interface of string) -  The value of this parameter is a comma-separated list of sort key. 
     * @param "Direction" (optional.String) -  The value of this parameter is a comma-separated list of sort direction. 
     * @param "Page" (optional.Float64) -  The page number.
     * @param "Size" (optional.Float64) -  The number of items returned in a single page.
     * @param "EntityIdInIdp" (optional.String) -  Entity identifier as determined by the owning Identity Provider. &lt;br&gt; This identifier can be retrieved using &lt;a href&#x3D;\&quot;#operation/Search Users By IdP\&quot;&gt;Search Users By Identity Provider API&lt;/a&gt; for users or &lt;a href&#x3D;\&quot;#operation/Search Groups by the IdP\&quot;&gt;Search Groups By Identity Provider API&lt;/a&gt; for groups. 
     * @param "EntityType" (optional.Interface of string) -  The directory entity type (User/Group/OU/API Client). 
     * @param "EntityName" (optional.String) -  The value of this parameter is entity name. 
     * @param "SubjectId" (optional.Interface of string) -  The ID of the Resource that assigned. 
     * @param "SubjectType" (optional.Interface of SubjectType) - 
     * @param "SubjectName" (optional.String) -  The Resource that assigned to the role name. 
     * @param "RoleType" (optional.Interface of RoleType) -  The role type (TenantAdmin/TenantViewer/SiteEditor/SiteConnectorDeployer/ApplicationOwner/PolicyOwner) that will assign to entity. 
@return RoleBindingsPage
*/

type CollectionsApiListRoleBindingsOpts struct {
    Sort optional.Interface
    Direction optional.String
    Page optional.Float64
    Size optional.Float64
    EntityIdInIdp optional.String
    EntityType optional.Interface
    EntityName optional.String
    SubjectId optional.Interface
    SubjectType optional.Interface
    SubjectName optional.String
    RoleType optional.Interface
}

func (a *CollectionsApiService) ListRoleBindings(ctx context.Context, localVarOptionals *CollectionsApiListRoleBindingsOpts) (RoleBindingsPage, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue RoleBindingsPage
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/collection/role-bindings"
	...
	if localVarOptionals != nil && localVarOptionals.EntityIdInIdp.IsSet() {
		localVarQueryParams.Add("entityIdInIdp", parameterToString(localVarOptionals.EntityIdInIdp.Value(), ""))
	}
	...
	if localVarOptionals != nil && localVarOptionals.SubjectName.IsSet() {
		localVarQueryParams.Add("subjectName", parameterToString(localVarOptionals.SubjectName.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.RoleType.IsSet() {
		localVarQueryParams.Add("roleType", parameterToString(localVarOptionals.RoleType.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
/*
CollectionsApiService Unlinks site from collection
Unlink Site from Collection in your Symantec ZTNA tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param collectionId The collection ID.
 * @param siteId The site ID.
 * @param optional nil or *CollectionsApiUnlinkASiteFromACollectionOpts - Optional Parameters:
     * @param "Body" (optional.Interface of CollectionidSiteidBody) - 

*/

type CollectionsApiUnlinkASiteFromACollectionOpts struct {
    Body optional.Interface
}

func (a *CollectionsApiService) UnlinkASiteFromACollection(ctx context.Context, collectionId string, siteId string, localVarOptionals *CollectionsApiUnlinkASiteFromACollectionOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/collection/site-links/{collection-id}/{site-id}"
	localVarPath = strings.Replace(localVarPath, "{"+"collection-id"+"}", fmt.Sprintf("%v", collectionId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"site-id"+"}", fmt.Sprintf("%v", siteId), -1)
...
@return Collection
*/
func (a *CollectionsApiService) UpdateACollection(ctx context.Context, body CollectionCollectionidBody, collectionId string) (Collection, *http.Response, error) {
	var (
