 ...
 * @param identityProviderId The identity provider id. This unique identifier can be retrieved using  &lt;a href&#x3D;\&quot;#operation/List Identity Providers\&quot;&gt;List Identity Providers API&lt;/a&gt;. &lt;br&gt; For Symantec ZTNA internal Identity Provider, set this property to local. 
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *UsersApiCreateLocalUserOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Object) - 
@return User
*/

type UsersApiCreateLocalUserOpts struct {
    Body optional.Interface
}

func (a *UsersApiService) CreateLocalUser(ctx context.Context, localVarOptionals *UsersApiCreateLocalUserOpts) (User, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *UsersApiService) DeleteUser(ctx context.Context, identityProviderId string, entityId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
UsersApiService Search Users By Identity Provider
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param identityProviderId The identity provider id. This unique identifier can be retrieved using  &lt;a href&#x3D;\&quot;#operation/List Identity Providers\&quot;&gt;List Identity Providers API&lt;/a&gt;. &lt;br&gt; For Symantec ZTNA internal Identity Provider, set this property to local. 
 * @param optional nil or *UsersApiSearchUsersByIdPOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  The string by which the results are filtered (see description) 
     * @param "PageOffset" (optional.Interface of PageOffset) -  Page number. Depending on the Identity Provider, this field can either be a  number or a string. It can&#x27;t be assumed and a valid value must be used from the response returned for the previous page. If not specified, first page is returned. 
     * @param "SortBy" (optional.String) -  The value of this parameter is a combination of sort key and sort direction: \\&lt;field\\&gt;:\\&lt;direction\\&gt;. Sort directions are either &#x27;asc&#x27; for ascending or &#x27;desc&#x27; for descending. The supported sort keys are ‘email’ for a user and name for a group. By default, query results are sorted in ascending order by ‘email’. 
     * @param "PerPage" (optional.Float64) -  The number of items returned in a single page.
...
type UsersApiSearchUsersByIdPOpts struct {
    Filter optional.String
    PageOffset optional.Interface
    SortBy optional.String
    PerPage optional.Float64
    Email optional.String
}

func (a *UsersApiService) SearchUsersByIdP(ctx context.Context, identityProviderId string, localVarOptionals *UsersApiSearchUsersByIdPOpts) (UsersPage, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param entityId Entity identifier as determined by the owning Identity Provider. &lt;br&gt; This identifier can be retrieved using &lt;a href&#x3D;\&quot;#operation/Search Users By IdP\&quot;&gt;Search Users By Identity Provider API&lt;/a&gt; for users or &lt;a href&#x3D;\&quot;#operation/Search Groups by the IdP\&quot;&gt;Search Groups By Identity Provider API&lt;/a&gt; for groups. 
 * @param optional nil or *UsersApiUpdateLocalUserOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Object) - 
@return User
*/

type UsersApiUpdateLocalUserOpts struct {
    Body optional.Interface
}

func (a *UsersApiService) UpdateLocalUser(ctx context.Context, entityId string, localVarOptionals *UsersApiUpdateLocalUserOpts) (User, *http.Response, error) {
	var (
