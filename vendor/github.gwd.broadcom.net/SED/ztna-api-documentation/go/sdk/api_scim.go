 ...
 * @param optional nil or *SCIMApiCreateASCIMGroupOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ScimGroupsBody) - 
@return ScimGroup
*/

type SCIMApiCreateASCIMGroupOpts struct {
    Body optional.Interface
}

func (a *SCIMApiService) CreateASCIMGroup(ctx context.Context, identityProviderId string, localVarOptionals *SCIMApiCreateASCIMGroupOpts) (ScimGroup, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param identityProviderId The identity provider id. This unique identifier can be retrieved using  &lt;a href&#x3D;\&quot;#operation/List Identity Providers\&quot;&gt;List Identity Providers API&lt;/a&gt;. &lt;br&gt; For Symantec ZTNA internal Identity Provider, set this property to local. 
 * @param optional nil or *SCIMApiCreateASCIMUserOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ScimUsersBody) - 
@return ScimUser
*/

type SCIMApiCreateASCIMUserOpts struct {
    Body optional.Interface
}

func (a *SCIMApiService) CreateASCIMUser(ctx context.Context, identityProviderId string, localVarOptionals *SCIMApiCreateASCIMUserOpts) (ScimUser, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *SCIMApiService) DeleteASCIMGroup(ctx context.Context, identityProviderId string, groupId string) (*http.Response, error) {
	var (
...
*/
func (a *SCIMApiService) DeleteASCIMUser(ctx context.Context, identityProviderId string, userId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return ScimGroup
*/
func (a *SCIMApiService) GetASCIMGroup(ctx context.Context, identityProviderId string, groupId string) (ScimGroup, *http.Response, error) {
	var (
...
@return ScimUser
*/
func (a *SCIMApiService) GetASCIMUser(ctx context.Context, identityProviderId string, userId string) (ScimUser, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *SCIMApiService) ListSCIMGroups(ctx context.Context, identityProviderId string) (ScimGroupsPage, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *SCIMApiService) ListSCIMUsers(ctx context.Context, identityProviderId string) (ScimUsersPage, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return ScimGroup
*/
func (a *SCIMApiService) ModifyASCIMGroup(ctx context.Context, body GroupsGroupidBody1, identityProviderId string, groupId string) (ScimGroup, *http.Response, error) {
	var (
 ...
 * @param identityProviderId The identity provider id. This unique identifier can be retrieved using  &lt;a href&#x3D;\&quot;#operation/List Identity Providers\&quot;&gt;List Identity Providers API&lt;/a&gt;. &lt;br&gt; For Symantec ZTNA internal Identity Provider, set this property to local. 
 * @param groupId The group ID.
 * @param optional nil or *SCIMApiUpdateASCIMGroupOpts - Optional Parameters:
     * @param "Body" (optional.Interface of GroupsGroupidBody) - 
@return ScimGroup
*/

type SCIMApiUpdateASCIMGroupOpts struct {
    Body optional.Interface
}

func (a *SCIMApiService) UpdateASCIMGroup(ctx context.Context, identityProviderId string, groupId string, localVarOptionals *SCIMApiUpdateASCIMGroupOpts) (ScimGroup, *http.Response, error) {
	var (
 ...
 * @param identityProviderId The identity provider id. This unique identifier can be retrieved using  &lt;a href&#x3D;\&quot;#operation/List Identity Providers\&quot;&gt;List Identity Providers API&lt;/a&gt;. &lt;br&gt; For Symantec ZTNA internal Identity Provider, set this property to local. 
 * @param userId The user ID.
 * @param optional nil or *SCIMApiUpdateASCIMUserOpts - Optional Parameters:
     * @param "Body" (optional.Interface of UsersUseridBody) - 
@return ScimUser
*/

type SCIMApiUpdateASCIMUserOpts struct {
    Body optional.Interface
}

func (a *SCIMApiService) UpdateASCIMUser(ctx context.Context, identityProviderId string, userId string, localVarOptionals *SCIMApiUpdateASCIMUserOpts) (ScimUser, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
