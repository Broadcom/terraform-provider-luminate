...
/*
SitesApiService Create Site
Creates a Site in your Symantec ZTNA tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SitesApiCreateASiteOpts - Optional Parameters:
     * @param "Body" (optional.Interface of SitesBody) - 
@return Site
*/

type SitesApiCreateASiteOpts struct {
    Body optional.Interface
}

func (a *SitesApiService) CreateASite(ctx context.Context, localVarOptionals *SitesApiCreateASiteOpts) (Site, *http.Response, error) {
	var (
...
/*
SitesApiService Delete Site
Delete a site from your Symantec ZTNA tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId Site ID.

*/
func (a *SitesApiService) DeleteASite(ctx context.Context, siteId string) (*http.Response, error) {
	var (
...
/*
SitesApiService Get Region By Name
Returns details of a connectivity region 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param regionName Region name
@return Region
*/
func (a *SitesApiService) GetARegion(ctx context.Context, regionName string) (Region, *http.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"region-name"+"}", fmt.Sprintf("%v", regionName), -1)
...
/*
SitesApiService Get Site
Returns the details of a Site from your Symantec ZTNA tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId The Site ID.
@return Site
*/
func (a *SitesApiService) GetASite(ctx context.Context, siteId string) (Site, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
SitesApiService Get Site Health Status
Returns the health status of a site from your Symantec ZTNA tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId Site ID.
@return SiteStatus
*/
func (a *SitesApiService) GetASitesHealthStatus(ctx context.Context, siteId string) (SiteStatus, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue SiteStatus
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/sites/{site-id}/status"
	localVarPath = strings.Replace(localVarPath, "{"+"site-id"+"}", fmt.Sprintf("%v", siteId), -1)
...
/*
SitesApiService List Sites
Return an array of paginated JSON objects. Each object represents a site configured in your Symantec ZTNA tenant. &lt;br&gt; The supported sort keys are either ‘name’ for sorting by site name.&lt;br&gt; Filter applies for the following fields: \&quot;name\&quot; and \&quot;description\&quot;. &lt;br&gt; Using the query filter&#x3D;test will return all the sites for which one or more of the above listed fields contain \&quot;test\&quot; Filtering by Application ID may be applied - in such a case, Sites that are associated with this Application will be returned. If the Application ID does not exist then an empty array is returned. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SitesApiGetAllSitesOpts - Optional Parameters:
...
type SitesApiGetAllSitesOpts struct {
...
func (a *SitesApiService) GetAllSites(ctx context.Context, localVarOptionals *SitesApiGetAllSitesOpts) (SitesPage, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
SitesApiService List Regions
Returns a list of available connectivity regions 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []Region
*/
func (a *SitesApiService) ListRegions(ctx context.Context) ([]Region, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId The site ID.
 * @param optional nil or *SitesApiUpdateASiteOpts - Optional Parameters:
     * @param "Body" (optional.Interface of SitesSiteidBody) - 
@return Site
*/

type SitesApiUpdateASiteOpts struct {
    Body optional.Interface
}

func (a *SitesApiService) UpdateASite(ctx context.Context, siteId string, localVarOptionals *SitesApiUpdateASiteOpts) (Site, *http.Response, error) {
	var (
