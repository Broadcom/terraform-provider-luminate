...
*/
func (a *GroupsApiService) AssignAUserToAGroup(ctx context.Context, groupId string, userId string) (*http.Response, error) {
	var (
 ...
 * @param optional nil or *GroupsApiCreateAGroupOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Object) - 
@return Group
*/

type GroupsApiCreateAGroupOpts struct {
    Body optional.Interface
}

func (a *GroupsApiService) CreateAGroup(ctx context.Context, identityProviderId string, localVarOptionals *GroupsApiCreateAGroupOpts) (Group, *http.Response, error) {
	var (
...
*/
func (a *GroupsApiService) DeleteAGroup(ctx context.Context, identityProviderId string, entityId string) (*http.Response, error) {
	var (
...
@return Group
*/
func (a *GroupsApiService) GetAGroup(ctx context.Context, identityProviderId string, entityId string) (Group, *http.Response, error) {
	var (
 ...
 * @param identityProviderId The identity provider id. This unique identifier can be retrieved using  &lt;a href&#x3D;\&quot;#operation/List Identity Providers\&quot;&gt;List Identity Providers API&lt;/a&gt;. &lt;br&gt; For Symantec ZTNA internal Identity Provider, set this property to local. 
 * @param entityId Entity identifier as determined by the owning Identity Provider. &lt;br&gt; This identifier can be retrieved using &lt;a href&#x3D;\&quot;#operation/Search Users By IdP\&quot;&gt;Search Users By Identity Provider API&lt;/a&gt; for users or &lt;a href&#x3D;\&quot;#operation/Search Groups by the IdP\&quot;&gt;Search Groups By Identity Provider API&lt;/a&gt; for groups. 
 * @param optional nil or *GroupsApiListAGroupsAssignedUsersOpts - Optional Parameters:
...
type GroupsApiListAGroupsAssignedUsersOpts struct {
    PageOffset optional.Interface
    PerPage optional.Float64
}

func (a *GroupsApiService) ListAGroupsAssignedUsers(ctx context.Context, identityProviderId string, entityId string, localVarOptionals *GroupsApiListAGroupsAssignedUsersOpts) (UsersPage, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *GroupsApiService) RemoveAUserFromAGroup(ctx context.Context, groupId string, userId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
GroupsApiService Search Groups By Identity Provider
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param identityProviderId The identity provider id. This unique identifier can be retrieved using  &lt;a href&#x3D;\&quot;#operation/List Identity Providers\&quot;&gt;List Identity Providers API&lt;/a&gt;. &lt;br&gt; For Symantec ZTNA internal Identity Provider, set this property to local. 
 * @param optional nil or *GroupsApiSearchGroupsByTheIdPOpts - Optional Parameters:
...
type GroupsApiSearchGroupsByTheIdPOpts struct {
...
func (a *GroupsApiService) SearchGroupsByTheIdP(ctx context.Context, identityProviderId string, localVarOptionals *GroupsApiSearchGroupsByTheIdPOpts) (GroupsPage, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
