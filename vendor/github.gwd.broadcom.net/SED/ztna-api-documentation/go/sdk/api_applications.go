...
/*
ApplicationsApiService Bind Application to Site
Bind your Application to an existing Site in your Symantec ZTNA tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param applicationId Application ID.
 * @param siteId Site ID.
 * @param optional nil or *ApplicationsApiBindAnApplicationToASiteOpts - Optional Parameters:
     * @param "Body" (optional.Interface of SitebindingSiteidBody) - 

*/

type ApplicationsApiBindAnApplicationToASiteOpts struct {
    Body optional.Interface
}

func (a *ApplicationsApiService) BindAnApplicationToASite(ctx context.Context, applicationId string, siteId string, localVarOptionals *ApplicationsApiBindAnApplicationToASiteOpts) (*http.Response, error) {
	var (
...
/*
ApplicationsApiService Create Application
Creates an application in your Symantec ZTNA tenant.  **Note:** To allow access to a newly created application, you should have a Site defined and Symantec ZTNA Connectors deployed, as well as access policy, this application assigned to. You can then assign the application to the required site using  &lt;a href&#x3D;\&quot;#operation/Bind an Application to a Site\&quot;&gt;Bind Application to Site API&lt;/a&gt;.  You can assign the application to the policy using &lt;a href&#x3D;\&quot;#operation/Assign an Application to Policies\&quot;&gt;Assign Application to policies&lt;/a&gt;. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ApplicationsApiCreateAnApplicationOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ApplicationsBody) - 
@return Application
*/

type ApplicationsApiCreateAnApplicationOpts struct {
    Body optional.Interface
}

func (a *ApplicationsApiService) CreateAnApplication(ctx context.Context, localVarOptionals *ApplicationsApiCreateAnApplicationOpts) (Application, *http.Response, error) {
	var (
...
*/
func (a *ApplicationsApiService) DeleteAnApplication(ctx context.Context, applicationId string) (*http.Response, error) {
	var (
...
type ApplicationsApiGetAllApplicationsOpts struct {
...
func (a *ApplicationsApiService) GetAllApplications(ctx context.Context, localVarOptionals *ApplicationsApiGetAllApplicationsOpts) (ApplicationsPage, *http.Response, error) {
	var (
...
@return Application
*/
func (a *ApplicationsApiService) GetAnApplication(ctx context.Context, applicationId string) (Application, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ApplicationsApiService) GetTheApplicationHealth(ctx context.Context, applicationId string) (ApplicationHealth, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param applicationId Application ID.
 * @param optional nil or *ApplicationsApiUpdateAnApplicationOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ApplicationsApplicationidBody) - 
@return Application
*/

type ApplicationsApiUpdateAnApplicationOpts struct {
    Body optional.Interface
}

func (a *ApplicationsApiService) UpdateAnApplication(ctx context.Context, applicationId string, localVarOptionals *ApplicationsApiUpdateAnApplicationOpts) (Application, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
