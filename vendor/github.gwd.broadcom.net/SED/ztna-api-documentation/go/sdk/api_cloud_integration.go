...
Create a new cloud integration configuration in your Symantec ZTNA tenant.&lt;br&gt; 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
@return CloudIntegration
*/
func (a *CloudIntegrationApiService) CreateACloudIntegration(ctx context.Context, body CloudintegrationsIntegrationsBody) (CloudIntegration, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CloudIntegration
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/cloud-integrations/integrations"
...
Delete a Cloud Integration configuration from your Symantec ZTNA tenant. &lt;br&gt; 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param cloudIntegrationId Cloud Integration ID

*/
func (a *CloudIntegrationApiService) DeleteACloudIntegration(ctx context.Context, cloudIntegrationId string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/cloud-integrations/integrations/{cloud-integration-id}"
	localVarPath = strings.Replace(localVarPath, "{"+"cloud-integration-id"+"}", fmt.Sprintf("%v", cloudIntegrationId), -1)
...
Return a Cloud Integration configuration from your Symantec ZTNA tenant. &lt;br&gt; 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param cloudIntegrationId Cloud Integration ID
@return CloudIntegration
*/
...
Return an array of JSON objects. Each object represents a Cloud Integration configuration in your Symantec ZTNA tenant. &lt;br&gt; 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []CloudIntegration
*/
...
/*
CloudIntegrationApiService Update Cloud Integration Configuration
Update an existing Cloud Integration configuration in your Symantec ZTNA tenant. &lt;br&gt; 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param cloudIntegrationId Cloud Integration ID
 * @param optional nil or *CloudIntegrationApiUpdateACloudIntegrationOpts - Optional Parameters:
     * @param "Body" (optional.Interface of IntegrationsCloudintegrationidBody) - 
@return CloudIntegration
*/

type CloudIntegrationApiUpdateACloudIntegrationOpts struct {
    Body optional.Interface
}

func (a *CloudIntegrationApiService) UpdateACloudIntegration(ctx context.Context, cloudIntegrationId string, localVarOptionals *CloudIntegrationApiUpdateACloudIntegrationOpts) (CloudIntegration, *http.Response, error) {
	var (
