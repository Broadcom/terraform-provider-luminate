...
// A JSON object of the log data fields and values.
type ForensicsLogResultData struct {
	Timestamp float64 `json:"@timestamp,omitempty"`
	ActionResult string `json:"action_result,omitempty"`
	// Refers to Web and SSH application type. 
	ActivityType string `json:"activity_type,omitempty"`
	AppExternalAddress string `json:"app_external_address,omitempty"`
	AppId string `json:"app_id,omitempty"`
	AppName string `json:"app_name,omitempty"`
	AppType string `json:"app_type,omitempty"`
	// Refers to SSH, TCP and RDP application type. 
	AuthenticationMethod string `json:"authentication_method,omitempty"`
	// Refers to Web application type. 
	...
	// Refers to Device Validation logs. 
	DeviceValidationActionType string `json:"device_validation_action_type,omitempty"`
	EntityId string `json:"entity_id,omitempty"`
	EntityName string `json:"entity_name,omitempty"`
	EntityType string `json:"entity_type,omitempty"`
	EntityIdpId string `json:"entity_idp_id,omitempty"`
	ErrorType string `json:"error_type,omitempty"`
	EventType string `json:"event_type,omitempty"`
	Geoip *LogGeoIp `json:"geoip,omitempty"`
	GlobalRequestId string `json:"global_request_id,omitempty"`
	// Refers to Web application type. 
	HashedSessionId string `json:"hashed_session_id,omitempty"`
	HttpCommand string `json:"http_command,omitempty"`
	HttpVersion string `json:"http_version,omitempty"`
	InternalIp string `json:"internal_ip,omitempty"`
	// Refers to Key Management logs. 
	KeyActionType string `json:"key_action_type,omitempty"`
	// Refers to Key Management logs. 
	KeyEventTargetUserName string `json:"key_event_target_user_name,omitempty"`
	// A unique identifier of the log.
	LogId string `json:"log_id,omitempty"`
	LogType string `json:"log_type,omitempty"`
	// Refers to MFA logs. 
	MfaActionType string `json:"mfa_action_type,omitempty"`
	PolicyId string `json:"policy_id,omitempty"`
	PolicyName string `json:"policy_name,omitempty"`
	PolicyType string `json:"policy_type,omitempty"`
	PolicyIsStatic string `json:"policy_is_static,omitempty"`
	// Refers to Web application type. 
	Referrer string `json:"referrer,omitempty"`
	// Refers to Web application type. 
	ResponseTime float64 `json:"response_time,omitempty"`
	// Field in SSH activity log. 
	SshActivityCommand string `json:"ssh_activity_command,omitempty"`
	// Internal user of SSH client. 
	SshClientInternalUser string `json:"ssh_client_internal_user,omitempty"`
	// Field in SSH activity log. 
	SshInternalResourceIdentifier string `json:"ssh_internal_resource_identifier,omitempty"`
	// Field in SSH activity log. 
	SshInternalResourcePort string `json:"ssh_internal_resource_port,omitempty"`
	StatusCode float64 `json:"status_code,omitempty"`
	Summary string `json:"summary,omitempty"`
	// Field in TCP activity log. 
	TcpInternalResourceIdentifier string `json:"tcp_internal_resource_identifier,omitempty"`
	// Field in TCP activity log. 
	TcpInternalResourcePort string `json:"tcp_internal_resource_port,omitempty"`
	TenantId string `json:"tenant_id,omitempty"`
	// Refers to Web application type. 
	TimeToFirstByte float64 `json:"time_to_first_byte,omitempty"`
	// Refers to Web application type. 
	UpStreamResponseTime float64 `json:"up_stream_response_time,omitempty"`
	// Refers to Web application type. 
	Uri string `json:"uri,omitempty"`
	UserAgent string `json:"user_agent,omitempty"`
	UserAgentFull *LogUserAgentFull `json:"user_agent_full,omitempty"`
	WssAgentDeviceId string `json:"wss_agent_device_id,omitempty"`
	WssAgentDeviceVersion string `json:"wss_agent_device_version,omitempty"`
	WssAgentType string `json:"wss_agent_type,omitempty"`
	WssDeviceName string `json:"wss_device_name,omitempty"`
	WssOsInfo string `json:"wss_os_info,omitempty"`
}
