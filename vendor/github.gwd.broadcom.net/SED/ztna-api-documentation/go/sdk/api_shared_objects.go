 ...
 * @param optional nil or *SharedObjectsApiCreateASharedObjectOpts - Optional Parameters:
     * @param "Body" (optional.Interface of PoliciesSharedobjectsBody) - 
@return SharedObject
*/

type SharedObjectsApiCreateASharedObjectOpts struct {
    Body optional.Interface
}

func (a *SharedObjectsApiService) CreateASharedObject(ctx context.Context, localVarOptionals *SharedObjectsApiCreateASharedObjectOpts) (SharedObject, *http.Response, error) {
	var (
...
*/
func (a *SharedObjectsApiService) DeleteASharedObject(ctx context.Context, sharedObjectId string) (*http.Response, error) {
	var (
...
@return SharedObject
*/
func (a *SharedObjectsApiService) GetASharedObject(ctx context.Context, sharedObjectId string) (SharedObject, *http.Response, error) {
	var (
 ...
 * @param optional nil or *SharedObjectsApiListSharedObjectsOpts - Optional Parameters:
     ...
     * @param "Type_" (optional.String) -  A shared object type to search by 
@return SharedObjectsPage
*/
...
func (a *SharedObjectsApiService) ListSharedObjects(ctx context.Context, localVarOptionals *SharedObjectsApiListSharedObjectsOpts) (SharedObjectsPage, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue SharedObjectsPage
	)
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param sharedObjectId Shared Object ID.
 * @param optional nil or *SharedObjectsApiUpdateASharedObjectOpts - Optional Parameters:
     * @param "Body" (optional.Interface of SharedobjectsSharedobjectidBody) - 
@return SharedObject
*/

type SharedObjectsApiUpdateASharedObjectOpts struct {
    Body optional.Interface
}

func (a *SharedObjectsApiService) UpdateASharedObject(ctx context.Context, sharedObjectId string, localVarOptionals *SharedObjectsApiUpdateASharedObjectOpts) (SharedObject, *http.Response, error) {
	var (
