...
type AccessAndActivityPoliciesApiService service
/*
AccessAndActivityPoliciesApiService Assign Application to policies
Assign explicit application to the existent policies. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param applicationId Application ID.
 * @param optional nil or *AccessAndActivityPoliciesApiAssignAnApplicationToPoliciesOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ByappidApplicationidBody1) - 

*/

type AccessAndActivityPoliciesApiAssignAnApplicationToPoliciesOpts struct {
    Body optional.Interface
}

func (a *AccessAndActivityPoliciesApiService) AssignAnApplicationToPolicies(ctx context.Context, applicationId string, localVarOptionals *AccessAndActivityPoliciesApiAssignAnApplicationToPoliciesOpts) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/policies/by-app-id/{application-id}"
...
/*
AccessAndActivityPoliciesApiService Create Policy
Creates an Access / Activity Policy in your Symantec ZTNA tenant. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *AccessAndActivityPoliciesApiCreateAnAccessOrActivityPolicyOpts - Optional Parameters:
     * @param "Body" (optional.Interface of PoliciesBody) - 
@return Policy
*/

type AccessAndActivityPoliciesApiCreateAnAccessOrActivityPolicyOpts struct {
    Body optional.Interface
}

func (a *AccessAndActivityPoliciesApiService) CreateAnAccessOrActivityPolicy(ctx context.Context, localVarOptionals *AccessAndActivityPoliciesApiCreateAnAccessOrActivityPolicyOpts) (Policy, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *AccessAndActivityPoliciesApiService) DeleteAPolicy(ctx context.Context, policyId string) (*http.Response, error) {
	var (
...
@return Policy
*/
func (a *AccessAndActivityPoliciesApiService) GetAPolicy(ctx context.Context, policyId string) (Policy, *http.Response, error) {
	var (
...
/*
AccessAndActivityPoliciesApiService List Policies
Return an array of paginated JSON objects. Each object represents a policy configured in your Symantec ZTNA tenant. &lt;br&gt; The supported sort keys are either ‘name’ for sorting by policy name or ‘id’ for sorting by policy id.&lt;br&gt; Filter applies for the policy name only. &lt;br&gt; Using the query filter&#x3D;testpolicy will return all the policies for which one or more of the above listed fields contain \&quot;testpolicy\&quot; 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *AccessAndActivityPoliciesApiGetAllPoliciesOpts - Optional Parameters:
...
type AccessAndActivityPoliciesApiGetAllPoliciesOpts struct {
...
func (a *AccessAndActivityPoliciesApiService) GetAllPolicies(ctx context.Context, localVarOptionals *AccessAndActivityPoliciesApiGetAllPoliciesOpts) (PoliciesPage, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
Returns an array of JSON objects. &lt;br&gt; Each object represents a policy assigned to the provided application in your Symantec ZTNA. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param applicationId Application ID.
@return []PolicyByType
*/
func (a *AccessAndActivityPoliciesApiService) GetPoliciesAssignedToAnApplication(ctx context.Context, applicationId string) ([]PolicyByType, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue []PolicyByType
	)
...
Returns the actions that can be enforced when a user performs a specific operation. Examples are: ALLOW to allow the action, BLOCK to block the action, BLOCK_USER to disconnect all active sessions of the user and block further login attempts. &lt;br&gt; 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
AccessAndActivityPoliciesApiService Remove application from policies
Remove explicit application from the policies. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param applicationId Application ID.
 * @param optional nil or *AccessAndActivityPoliciesApiRemoveAnApplicationFromPoliciesOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ByappidApplicationidBody2) - 

*/

type AccessAndActivityPoliciesApiRemoveAnApplicationFromPoliciesOpts struct {
    Body optional.Interface
}

func (a *AccessAndActivityPoliciesApiService) RemoveAnApplicationFromPolicies(ctx context.Context, applicationId string, localVarOptionals *AccessAndActivityPoliciesApiRemoveAnApplicationFromPoliciesOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
AccessAndActivityPoliciesApiService Update Policy
Update an existing policy in your Symantec ZTNA tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param policyId Policy ID.
 * @param optional nil or *AccessAndActivityPoliciesApiUpdateAPolicyOpts - Optional Parameters:
     * @param "Body" (optional.Interface of PoliciesPolicyidBody) - 
@return Policy
*/

type AccessAndActivityPoliciesApiUpdateAPolicyOpts struct {
    Body optional.Interface
}

func (a *AccessAndActivityPoliciesApiService) UpdateAPolicy(ctx context.Context, policyId string, localVarOptionals *AccessAndActivityPoliciesApiUpdateAPolicyOpts) (Policy, *http.Response, error) {
	var (
...
/*
AccessAndActivityPoliciesApiService Update application in policies
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param applicationId Application ID.
 * @param optional nil or *AccessAndActivityPoliciesApiUpdateApplicationsAssignedToPoliciesOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ByappidApplicationidBody) - 

*/

type AccessAndActivityPoliciesApiUpdateApplicationsAssignedToPoliciesOpts struct {
    Body optional.Interface
}

func (a *AccessAndActivityPoliciesApiService) UpdateApplicationsAssignedToPolicies(ctx context.Context, applicationId string, localVarOptionals *AccessAndActivityPoliciesApiUpdateApplicationsAssignedToPoliciesOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
