 ...
 * @param body 
 * @param optional nil or *SearchSSHlogsOpts - Optional Parameters:
     * @param "ContentType" (optional.String) -  

@return SshLogSearchResults
*/

type SearchSSHlogsOpts struct { 
	ContentType optional.String
}

func (a *SSHLogsApiService) SearchSSHlogs(ctx context.Context, body LogSearch, localVarOptionals *SearchSSHlogsOpts) (SshLogSearchResults, *http.Response, error) {
	var (
