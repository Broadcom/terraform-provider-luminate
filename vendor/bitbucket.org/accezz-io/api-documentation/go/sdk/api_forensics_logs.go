...
type ForensicsLogsApiService service
 ...
 * @param body 
 * @param optional nil or *SearchForensicslogsOpts - Optional Parameters:
     * @param "ContentType" (optional.String) -  

@return ForensicsLogSearchResults
*/

type SearchForensicslogsOpts struct { 
	ContentType optional.String
}

func (a *ForensicsLogsApiService) SearchForensicslogs(ctx context.Context, body LogSearch, localVarOptionals *SearchForensicslogsOpts) (ForensicsLogSearchResults, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ForensicsLogSearchResults
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/logs/forensics"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ForensicsLogSearchResults
