...
type User struct {
	// The identity with which the user logs in.
	...
	RepositoryType *IdentityProviderType `json:"repository_type,omitempty"`
	// Applies for local users only. Indication whether Kerberos SSO is enabled for this user. <br> Enabling Kerberos SSO allows performing single sign-on against Kerberos enabled applications by transforming local user email prefix to target AD user name. (requires <a href=https://support.luminate.io/hc/en-us/articles/115000764832-Configuring-Kerberos-Constrained-Delegation-KCD-SSO-for-Corporate-Web-Applications>Kerberos Constrained Delegation</a><br>).
	UpnForwardForSsoEnabled bool `json:"upn_forward_for_sso_enabled,omitempty"`
	...
	// Indication whether the user has generated a long term SSH key.
	...
	HasMfaSecret bool `json:"hasMfaSecret,omitempty"`
	// Indication whether the user has generated a long term RDP key.
	HasRdpLongTermPassword bool `json:"hasRdpLongTermPassword,omitempty"`
	// A unique identifier of the user.
	Id string `json:"id"`
	// Identity Provider identifier. This uuid can be retrieved using <a href=\"#operation/ListIdentityProviders\">List Identity Providers API.</a>. This property equals 'local' when the Identity Provider is Secure Access Cloud internal one.
