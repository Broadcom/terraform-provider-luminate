...
type User struct {
	...
	// Identity Provider identifier. This property might include non-ascii characters (i.e. LDAP). In such a case, the client needs to use URL Encoding. This uuid can be retrieved using <a href=\"#operation/ListIdentityProviders\">List Identity Providers API.</a>. This property equals 'local' when the Identity Provider is Secure Access Cloud internal one.
