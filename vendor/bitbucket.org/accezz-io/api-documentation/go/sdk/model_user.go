...
type User struct {
	...
	Id string `json:"id"`
	// Identity Provider identifier. This uuid can be retrieved using <a href=\"#operation/ListIdentityProviders\">List Identity Providers API.</a>. This property equals 'local' when the Identity Provider is Luminate internal one.
