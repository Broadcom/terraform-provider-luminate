...
Deletes a user permanently from Luminate Identity Provider in your Luminate tenant.
...
*/
func (a *UsersApiService) IdentitiesLocalUsersByEntityIdDelete(ctx context.Context, entityId string) (*http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/identities/local/users/{entity-id}"
...
/*
UsersApiService Update Local User.
Updates an existing user in Luminate Identity Provider in your Luminate tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param entityId Entity identifier as determined by the owning Identity Provider. &lt;br&gt; This identifier can be retrieved using &lt;a href&#x3D;\&quot;#operation/SearchUsersbyIdp\&quot;&gt;Search Users By Identity Provider API&lt;/a&gt; for users or &lt;a href&#x3D;\&quot;#operation/SearchGroupsbyIdp\&quot;&gt;Search Groups By Identity Provider API&lt;/a&gt; for groups.
 * @param optional nil or *IdentitiesLocalUsersByEntityIdPutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of User) -

@return User
*/

type IdentitiesLocalUsersByEntityIdPutOpts struct {
	Body optional.Interface
}

func (a *UsersApiService) IdentitiesLocalUsersByEntityIdPut(ctx context.Context, entityId string, localVarOptionals *IdentitiesLocalUsersByEntityIdPutOpts) (User, *http.Response, error) {
	var (
...
/*
UsersApiService Create Local User.
Creates a new user in Luminate Identity Provider in your Luminate tenant. In the request body. repository_type should be set to local.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *IdentitiesLocalUsersPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of User) -

@return User
*/

type IdentitiesLocalUsersPostOpts struct {
	Body optional.Interface
}

func (a *UsersApiService) IdentitiesLocalUsersPost(ctx context.Context, localVarOptionals *IdentitiesLocalUsersPostOpts) (User, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/identities/local/users"
...
@return []BlockedUser
*/
func (a *UsersApiService) IdentitiesSettingsBlockedUsersGet(ctx context.Context) ([]BlockedUser, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/identities/settings/blocked-users"
...
Unblocks a user in your Luminate tenant. Unblocking a group of users is not supported. Upon a successful operation, the user will be able to login to your tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param identityProviderId The identity provider id. This unique identifier can be retrieved using  &lt;a href&#x3D;\&quot;#operation/ListIdentityProviders\&quot;&gt;List Identity Providers API&lt;/a&gt;. &lt;br&gt; For Luminate internal Identity Provider, set this property to local.
 * @param entityId Entity identifier as determined by the owning Identity Provider. &lt;br&gt; This identifier can be retrieved using &lt;a href&#x3D;\&quot;#operation/SearchUsersbyIdp\&quot;&gt;Search Users By Identity Provider API&lt;/a&gt; for users or &lt;a href&#x3D;\&quot;#operation/SearchGroupsbyIdp\&quot;&gt;Search Groups By Identity Provider API&lt;/a&gt; for groups.


*/
func (a *UsersApiService) IdentitiesUsersBlockByIdentityProviderIdAndEntityIdDelete(ctx context.Context, identityProviderId string, entityId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/identities/{identity-provider-id}/users/{entity-id}/block"
...
Blocks a user in your Luminate tenant. Blocking a group of users is not supported. All active sessions of the given user will get disconnected and the user will no longer be able to login to your tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param identityProviderId The identity provider id. This unique identifier can be retrieved using  &lt;a href&#x3D;\&quot;#operation/ListIdentityProviders\&quot;&gt;List Identity Providers API&lt;/a&gt;. &lt;br&gt; For Luminate internal Identity Provider, set this property to local.
 * @param entityId Entity identifier as determined by the owning Identity Provider. &lt;br&gt; This identifier can be retrieved using &lt;a href&#x3D;\&quot;#operation/SearchUsersbyIdp\&quot;&gt;Search Users By Identity Provider API&lt;/a&gt; for users or &lt;a href&#x3D;\&quot;#operation/SearchGroupsbyIdp\&quot;&gt;Search Groups By Identity Provider API&lt;/a&gt; for groups.
...
*/
func (a *UsersApiService) IdentitiesUsersBlockByIdentityProviderIdAndEntityIdPost(ctx context.Context, identityProviderId string, entityId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
Return user by ID from the specified identity provider. For the local users repository in your Luminate tenant, set  identity-provider-id to &#39;local&#39;.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param identityProviderId The identity provider id. This unique identifier can be retrieved using  &lt;a href&#x3D;\&quot;#operation/ListIdentityProviders\&quot;&gt;List Identity Providers API&lt;/a&gt;. &lt;br&gt; For Luminate internal Identity Provider, set this property to local.
 * @param entityId Entity identifier as determined by the owning Identity Provider. &lt;br&gt; This identifier can be retrieved using &lt;a href&#x3D;\&quot;#operation/SearchUsersbyIdp\&quot;&gt;Search Users By Identity Provider API&lt;/a&gt; for users or &lt;a href&#x3D;\&quot;#operation/SearchGroupsbyIdp\&quot;&gt;Search Groups By Identity Provider API&lt;/a&gt; for groups.
...
@return User
*/
func (a *UsersApiService) IdentitiesUsersByIdentityProviderIdAndEntityIdGet(ctx context.Context, identityProviderId string, entityId string) (User, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/identities/{identity-provider-id}/users/{entity-id}"
	localVarPath = strings.Replace(localVarPath, "{"+"identity-provider-id"+"}", fmt.Sprintf("%v", identityProviderId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"entity-id"+"}", fmt.Sprintf("%v", entityId), -1)
...
/*
UsersApiService SearchUsersbyIdp
Return an array of JSON objects. Each object represents a user in the given IDP. &lt;br&gt; Pagination support is defined per Identity Provider. Filter applies for user name only.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param identityProviderId The identity provider id. This unique identifier can be retrieved using  &lt;a href&#x3D;\&quot;#operation/ListIdentityProviders\&quot;&gt;List Identity Providers API&lt;/a&gt;. &lt;br&gt; For Luminate internal Identity Provider, set this property to local.
 * @param optional nil or *IdentitiesUsersByIdentityProviderIdGetOpts - Optional Parameters:
     ...
     * @param "SortBy" (optional.Interface of string) -  The value of this parameter is a combination of sort key and sort direction: \\&lt;field\\&gt;:\\&lt;direction\\&gt;. Sort directions are either &#39;asc&#39; for ascending or &#39;desc&#39; for descending. The supported sort keys are ‘email’ for a user and name for a group. By default, query results are sorted in ascending order by ‘email’.
     * @param "ItemsPerPage" (optional.Int32) -  The number of items returned in a single page.
     * @param "DisablePagination" (optional.Bool) -  Indication whether to enable pagination. If enabled the response will have &#x60;content&#x60; as a root element.
     * @param "Email" (optional.String) -  e-mail by which the results are filtered. &lt;br&gt; Using the query email&#x3D;john will return all the entities whose email address contains \&quot;john\&quot;

@return UsersPage
*/

type IdentitiesUsersByIdentityProviderIdGetOpts struct {
	Filter            optional.String
	PageOffset        optional.String
	SortBy            optional.Interface
	ItemsPerPage      optional.Int32
	DisablePagination optional.Bool
	Email             optional.String
}

func (a *UsersApiService) IdentitiesUsersByIdentityProviderIdGet(ctx context.Context, identityProviderId string, localVarOptionals *IdentitiesUsersByIdentityProviderIdGetOpts) (UsersPage, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/identities/{identity-provider-id}/users"
	localVarPath = strings.Replace(localVarPath, "{"+"identity-provider-id"+"}", fmt.Sprintf("%v", identityProviderId), -1)
	...
	if localVarOptionals != nil && localVarOptionals.DisablePagination.IsSet() {
		localVarQueryParams.Add("DisablePagination", parameterToString(localVarOptionals.DisablePagination.Value(), ""))
	}
