 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CreateLocalUserOpts - Optional Parameters:
     * @param "Body" (optional.Interface of User) -  

@return User
*/

type CreateLocalUserOpts struct { 
	Body optional.Interface
}

func (a *UsersApiService) CreateLocalUser(ctx context.Context, localVarOptionals *CreateLocalUserOpts) (User, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param identityProviderId The identity provider id. This unique identifier can be retrieved using  &lt;a href&#x3D;\&quot;#operation/ListIdentityProviders\&quot;&gt;List Identity Providers API&lt;/a&gt;. &lt;br&gt; For Secure Access Cloud internal Identity Provider, set this property to local.
 * @param optional nil or *SearchUsersbyIdpOpts - Optional Parameters:
...
type SearchUsersbyIdpOpts struct { 
...
func (a *UsersApiService) SearchUsersbyIdp(ctx context.Context, identityProviderId string, localVarOptionals *SearchUsersbyIdpOpts) (UsersPage, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param entityId Entity identifier as determined by the owning Identity Provider. &lt;br&gt; This identifier can be retrieved using &lt;a href&#x3D;\&quot;#operation/SearchUsersbyIdp\&quot;&gt;Search Users By Identity Provider API&lt;/a&gt; for users or &lt;a href&#x3D;\&quot;#operation/SearchGroupsbyIdp\&quot;&gt;Search Groups By Identity Provider API&lt;/a&gt; for groups.
 * @param optional nil or *UpdateLocalUserOpts - Optional Parameters:
     * @param "Body" (optional.Interface of User) -  

@return User
*/

type UpdateLocalUserOpts struct { 
	Body optional.Interface
}

func (a *UsersApiService) UpdateLocalUser(ctx context.Context, entityId string, localVarOptionals *UpdateLocalUserOpts) (User, *http.Response, error) {
	var (
