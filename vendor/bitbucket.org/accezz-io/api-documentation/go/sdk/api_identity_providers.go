...
/*
IdentityProvidersApiService List Identity Providers
 ...
 * @param optional nil or *IdentityProvidersApiListIdentityProvidersOpts - Optional Parameters:
...
type IdentityProvidersApiListIdentityProvidersOpts struct {
	IncludeLocal optional.Bool
}

func (a *IdentityProvidersApiService) ListIdentityProviders(ctx context.Context, localVarOptionals *IdentityProvidersApiListIdentityProvidersOpts) ([]DirectoryProvider, *http.Response, error) {
	var (
