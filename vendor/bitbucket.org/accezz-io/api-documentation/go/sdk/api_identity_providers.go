...
Return an array of JSON objects. Each object represents an Identity Provider configured in your Luminate tenant. &lt;br&gt;
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *IdentitiesSettingsIdentityProvidersGetOpts - Optional Parameters:
     * @param "IncludeLocal" (optional.Bool) -  Indication whether to include Luminate internal Identity Provider in the response.

@return []DirectoryProvider
*/

type IdentitiesSettingsIdentityProvidersGetOpts struct {
	IncludeLocal optional.Bool
}

func (a *IdentityProvidersApiService) IdentitiesSettingsIdentityProvidersGet(ctx context.Context, localVarOptionals *IdentitiesSettingsIdentityProvidersGetOpts) ([]DirectoryProvider, *http.Response, error) {
	var (
