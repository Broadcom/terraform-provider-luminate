...
/*
IdentityProvidersApiService GetIdentityProviderById
Return an Identity Provider configuration by ID from your Secure Access Cloud tenant. &lt;br&gt;
...
*/
func (a *IdentityProvidersApiService) GetIdentityProviderById(ctx context.Context, identityProviderId string) (DirectoryProvider, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue DirectoryProvider
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/identities/settings/identity-providers/{identity-provider-id}"
...
/*
IdentityProvidersApiService ListIdentityProviders
Return an array of JSON objects. Each object represents an Identity Provider configuration in your Secure Access Cloud tenant. &lt;br&gt;
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ListIdentityProvidersOpts - Optional Parameters:
     * @param "IncludeLocal" (optional.Bool) -  Indication whether to include Secure Access Cloud internal Identity Provider in the response.

@return []DirectoryProvider
*/

type ListIdentityProvidersOpts struct {
	IncludeLocal optional.Bool
}

func (a *IdentityProvidersApiService) ListIdentityProviders(ctx context.Context, localVarOptionals *ListIdentityProvidersOpts) ([]DirectoryProvider, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/identities/settings/identity-providers"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}

	if localVarOptionals != nil && localVarOptionals.IncludeLocal.IsSet() {
		localVarQueryParams.Add("includeLocal", parameterToString(localVarOptionals.IncludeLocal.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{"application/json"}
