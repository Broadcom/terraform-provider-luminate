...
type Connector struct {
	...
	// Indicates whether the connector has already established a successful handshake with the Luminate Cloud.
	Registered bool `json:"registered,omitempty"`
	// When initiated, the Luminate Connector receives an ephemeral OTP, allowing it to establish initial communication. with Luminate Cloud Service and pull a TLS Certificate to be used for further communications. This property holds an empty value after the connector establishes a successful handshake with the Luminate Cloud.
	Otp string `json:"otp,omitempty"`
	// Connector creation date.
	DateCreated time.Time `json:"date_created,omitempty"`
	// The date when the connector established a successful handshake with the Luminate Cloud.
	...
	// Indicates whether the connector serves applications defined under the contained site. A disabled connector still communicates with Luminate cloud service to support enabling it later on.
	...
	// The internal IP address of the host running the Luminate connector container.
	InternalIp string `json:"internal_ip,omitempty"`
	// The IP address used by Luminate connector to address Luminate cloud.
	ExternalIp string `json:"external_ip,omitempty"`
	// The name of the host running the Luminate connector container.
	...
	// A persistent volume to be used for storing the Luminate connector TLS Certificate. <br> The persistent volume must be defined for deployments of type Kubernetes in order to support connector failovers. This property value is inherited from the contained site and can be overridden at the connector level.
