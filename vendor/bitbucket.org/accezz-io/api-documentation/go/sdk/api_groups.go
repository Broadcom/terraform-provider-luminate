...
Return group by ID from the specified identity provider. For the local users repository in your Luminate tenant, set identity-provider-id to &#39;local&#39;.
...
@return Group
*/
func (a *GroupsApiService) IdentitiesGroupsByIdentityProviderIdAndEntityIdGet(ctx context.Context, identityProviderId string, entityId string) (Group, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/identities/{identity-provider-id}/groups/{entity-id}"
...
/*
GroupsApiService SearchGroupsbyIdp
Return an array of JSON objects. Each object represents a group in the given IDP. &lt;br&gt; Pagination support is defined per Identity Provider. Filter applies for group name only.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param identityProviderId The identity provider id. This unique identifier can be retrieved using  &lt;a href&#x3D;\&quot;#operation/ListIdentityProviders\&quot;&gt;List Identity Providers API&lt;/a&gt;. &lt;br&gt; For Luminate internal Identity Provider, set this property to local.
 * @param optional nil or *IdentitiesGroupsByIdentityProviderIdGetOpts - Optional Parameters:
...
type IdentitiesGroupsByIdentityProviderIdGetOpts struct {
...
func (a *GroupsApiService) IdentitiesGroupsByIdentityProviderIdGet(ctx context.Context, identityProviderId string, localVarOptionals *IdentitiesGroupsByIdentityProviderIdGetOpts) (GroupsPage, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue GroupsPage
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/identities/{identity-provider-id}/groups"
	localVarPath = strings.Replace(localVarPath, "{"+"identity-provider-id"+"}", fmt.Sprintf("%v", identityProviderId), -1)
...
/*
GroupsApiService Delete Local Group.
Deletes a group permanently from Luminate Identity Provider in your Luminate tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param entityId Entity identifier as determined by the owning Identity Provider. &lt;br&gt; This identifier can be retrieved using &lt;a href&#x3D;\&quot;#operation/SearchUsersbyIdp\&quot;&gt;Search Users By Identity Provider API&lt;/a&gt; for users or &lt;a href&#x3D;\&quot;#operation/SearchGroupsbyIdp\&quot;&gt;Search Groups By Identity Provider API&lt;/a&gt; for groups.


*/
func (a *GroupsApiService) IdentitiesLocalGroupsByEntityIdDelete(ctx context.Context, entityId string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/identities/local/groups/{entity-id}"
	localVarPath = strings.Replace(localVarPath, "{"+"entity-id"+"}", fmt.Sprintf("%v", entityId), -1)
...
/*
GroupsApiService Update Local Group.
Updates an existing group in Luminate Identity Provider in your Luminate tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param entityId Entity identifier as determined by the owning Identity Provider. &lt;br&gt; This identifier can be retrieved using &lt;a href&#x3D;\&quot;#operation/SearchUsersbyIdp\&quot;&gt;Search Users By Identity Provider API&lt;/a&gt; for users or &lt;a href&#x3D;\&quot;#operation/SearchGroupsbyIdp\&quot;&gt;Search Groups By Identity Provider API&lt;/a&gt; for groups.
 * @param optional nil or *IdentitiesLocalGroupsByEntityIdPutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Group) -

@return Group
*/

type IdentitiesLocalGroupsByEntityIdPutOpts struct {
	Body optional.Interface
}

func (a *GroupsApiService) IdentitiesLocalGroupsByEntityIdPut(ctx context.Context, entityId string, localVarOptionals *IdentitiesLocalGroupsByEntityIdPutOpts) (Group, *http.Response, error) {
	var (
...
/*
GroupsApiService Create Local Group.
Creates a new group in Luminate Identity Provider in your Luminate tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *IdentitiesLocalGroupsPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Group) -

@return Group
*/

type IdentitiesLocalGroupsPostOpts struct {
	Body optional.Interface
}

func (a *GroupsApiService) IdentitiesLocalGroupsPost(ctx context.Context, localVarOptionals *IdentitiesLocalGroupsPostOpts) (Group, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/identities/local/groups"
