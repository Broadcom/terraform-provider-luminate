 ...
 * @param identityProviderId The identity provider id. This unique identifier can be retrieved using  &lt;a href&#x3D;\&quot;#operation/ListIdentityProviders\&quot;&gt;List Identity Providers API&lt;/a&gt;. &lt;br&gt; For Secure Access Cloud internal Identity Provider, set this property to local.
 * @param entityId Entity identifier as determined by the owning Identity Provider. &lt;br&gt; This identifier can be retrieved using &lt;a href&#x3D;\&quot;#operation/SearchUsersbyIdp\&quot;&gt;Search Users By Identity Provider API&lt;/a&gt; for users or &lt;a href&#x3D;\&quot;#operation/SearchGroupsbyIdp\&quot;&gt;Search Groups By Identity Provider API&lt;/a&gt; for groups.
 * @param optional nil or *GroupsApiListAssignedUsersOpts - Optional Parameters:
...
type GroupsApiListAssignedUsersOpts struct {
	PageOffset optional.Interface
	PerPage    optional.Float64
}

func (a *GroupsApiService) ListAssignedUsers(ctx context.Context, identityProviderId string, entityId string, localVarOptionals *GroupsApiListAssignedUsersOpts) (UsersPage, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param identityProviderId The identity provider id. This unique identifier can be retrieved using  &lt;a href&#x3D;\&quot;#operation/ListIdentityProviders\&quot;&gt;List Identity Providers API&lt;/a&gt;. &lt;br&gt; For Secure Access Cloud internal Identity Provider, set this property to local.
 * @param optional nil or *GroupsApiSearchGroupsbyIdpOpts - Optional Parameters:
...
type GroupsApiSearchGroupsbyIdpOpts struct {
...
func (a *GroupsApiService) SearchGroupsbyIdp(ctx context.Context, identityProviderId string, localVarOptionals *GroupsApiSearchGroupsbyIdpOpts) (GroupsPage, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
