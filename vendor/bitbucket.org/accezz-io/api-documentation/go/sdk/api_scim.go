...
/* 
SCIMApiService Create SCIM User
Create a SCIM user. 
 ...
 * @param body 
 * @param optional nil or *CreateSCIMUserOpts - Optional Parameters:
     * @param "ContentType" (optional.String) -  

@return ScimUser
*/

type CreateSCIMUserOpts struct { 
	ContentType optional.String
}

func (a *SCIMApiService) CreateSCIMUser(ctx context.Context, identityProviderId string, body ScimUser, localVarOptionals *CreateSCIMUserOpts) (ScimUser, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/identities/{identity-provider-id}/scim/users"
...
/* 
SCIMApiService Create a SCIM Group
Create a SCIM group. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param identityProviderId The identity provider id. This unique identifier can be retrieved using  &lt;a href&#x3D;\&quot;#operation/ListIdentityProviders\&quot;&gt;List Identity Providers API&lt;/a&gt;. &lt;br&gt; For Secure Access Cloud internal Identity Provider, set this property to local.
 * @param body 
 * @param optional nil or *CreateaSCIMGroupOpts - Optional Parameters:
     * @param "ContentType" (optional.String) -  

@return ScimGroup
*/

type CreateaSCIMGroupOpts struct { 
	ContentType optional.String
}

func (a *SCIMApiService) CreateaSCIMGroup(ctx context.Context, identityProviderId string, body ScimGroup, localVarOptionals *CreateaSCIMGroupOpts) (ScimGroup, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/identities/{identity-provider-id}/scim/groups"
	localVarPath = strings.Replace(localVarPath, "{"+"identity-provider-id"+"}", fmt.Sprintf("%v", identityProviderId), -1)
...
func (a *SCIMApiService) DeleteSCIMGroup(ctx context.Context, identityProviderId string, groupId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/identities/{identity-provider-id}/scim/groups/{group-id}"
	localVarPath = strings.Replace(localVarPath, "{"+"identity-provider-id"+"}", fmt.Sprintf("%v", identityProviderId), -1)
...
func (a *SCIMApiService) DeleteSCIMUser(ctx context.Context, identityProviderId string, userId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/identities/{identity-provider-id}/scim/users/{user-id}"
	localVarPath = strings.Replace(localVarPath, "{"+"identity-provider-id"+"}", fmt.Sprintf("%v", identityProviderId), -1)
...
/* 
SCIMApiService listSCIMGroupsAPI
...
func (a *SCIMApiService) ListSCIMGroupsAPI(ctx context.Context, identityProviderId string) (ScimGroupsPage, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ScimGroupsPage
	)
...
/* 
SCIMApiService listSCIMUsersAPI
...
func (a *SCIMApiService) ListSCIMUsersAPI(ctx context.Context, identityProviderId string) (ScimUsersPage, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ScimUsersPage
	)
 ...
 * @param groupId The group ID.
 * @param body 
 * @param optional nil or *ModifyaSCIMGroupOpts - Optional Parameters:
     * @param "ContentType" (optional.String) -  

@return ScimGroup
*/

type ModifyaSCIMGroupOpts struct { 
	ContentType optional.String
}

func (a *SCIMApiService) ModifyaSCIMGroup(ctx context.Context, identityProviderId string, groupId string, body ScimGroupPatch, localVarOptionals *ModifyaSCIMGroupOpts) (ScimGroup, *http.Response, error) {
	var (
...
/* 
SCIMApiService Update SCIM Group
Update an existing group.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param identityProviderId The identity provider id. This unique identifier can be retrieved using  &lt;a href&#x3D;\&quot;#operation/ListIdentityProviders\&quot;&gt;List Identity Providers API&lt;/a&gt;. &lt;br&gt; For Secure Access Cloud internal Identity Provider, set this property to local.
 * @param groupId The group ID.
 * @param body 
 * @param optional nil or *UpdateSCIMGroupOpts - Optional Parameters:
     * @param "ContentType" (optional.String) -  

@return ScimGroup
*/

type UpdateSCIMGroupOpts struct { 
	ContentType optional.String
}

func (a *SCIMApiService) UpdateSCIMGroup(ctx context.Context, identityProviderId string, groupId string, body ScimGroup, localVarOptionals *UpdateSCIMGroupOpts) (ScimGroup, *http.Response, error) {
	var (
...
/* 
SCIMApiService Update SCIM User
Update an existing SCIM user.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param identityProviderId The identity provider id. This unique identifier can be retrieved using  &lt;a href&#x3D;\&quot;#operation/ListIdentityProviders\&quot;&gt;List Identity Providers API&lt;/a&gt;. &lt;br&gt; For Secure Access Cloud internal Identity Provider, set this property to local.
 * @param userId The user ID.
 * @param body 
 * @param optional nil or *UpdateSCIMUserOpts - Optional Parameters:
     * @param "ContentType" (optional.String) -  

@return ScimUser
*/

type UpdateSCIMUserOpts struct { 
	ContentType optional.String
}

func (a *SCIMApiService) UpdateSCIMUser(ctx context.Context, identityProviderId string, userId string, body ScimUser, localVarOptionals *UpdateSCIMUserOpts) (ScimUser, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
