 ...
 * @param optional nil or *SCIMApiCreateSCIMGroupOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ScimGroupsBody) -
@return ScimGroup
*/

type SCIMApiCreateSCIMGroupOpts struct {
	Body optional.Interface
}

func (a *SCIMApiService) CreateSCIMGroup(ctx context.Context, identityProviderId string, localVarOptionals *SCIMApiCreateSCIMGroupOpts) (ScimGroup, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param identityProviderId The identity provider id. This unique identifier can be retrieved using  &lt;a href&#x3D;\&quot;#operation/ListIdentityProviders\&quot;&gt;List Identity Providers API&lt;/a&gt;. &lt;br&gt; For Secure Access Cloud internal Identity Provider, set this property to local.
 * @param optional nil or *SCIMApiCreateSCIMUserOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ScimUsersBody) -
@return ScimUser
*/

type SCIMApiCreateSCIMUserOpts struct {
	Body optional.Interface
}

func (a *SCIMApiService) CreateSCIMUser(ctx context.Context, identityProviderId string, localVarOptionals *SCIMApiCreateSCIMUserOpts) (ScimUser, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param identityProviderId The identity provider id. This unique identifier can be retrieved using  &lt;a href&#x3D;\&quot;#operation/ListIdentityProviders\&quot;&gt;List Identity Providers API&lt;/a&gt;. &lt;br&gt; For Secure Access Cloud internal Identity Provider, set this property to local.
 * @param groupId The group ID.
 * @param optional nil or *SCIMApiUpdateSCIMGroupOpts - Optional Parameters:
     * @param "Body" (optional.Interface of GroupsGroupidBody) -
@return ScimGroup
*/

type SCIMApiUpdateSCIMGroupOpts struct {
	Body optional.Interface
}

func (a *SCIMApiService) UpdateSCIMGroup(ctx context.Context, identityProviderId string, groupId string, localVarOptionals *SCIMApiUpdateSCIMGroupOpts) (ScimGroup, *http.Response, error) {
	var (
 ...
 * @param identityProviderId The identity provider id. This unique identifier can be retrieved using  &lt;a href&#x3D;\&quot;#operation/ListIdentityProviders\&quot;&gt;List Identity Providers API&lt;/a&gt;. &lt;br&gt; For Secure Access Cloud internal Identity Provider, set this property to local.
 * @param userId The user ID.
 * @param optional nil or *SCIMApiUpdateSCIMUserOpts - Optional Parameters:
     * @param "Body" (optional.Interface of UsersUseridBody) -
@return ScimUser
*/

type SCIMApiUpdateSCIMUserOpts struct {
	Body optional.Interface
}

func (a *SCIMApiService) UpdateSCIMUser(ctx context.Context, identityProviderId string, userId string, localVarOptionals *SCIMApiUpdateSCIMUserOpts) (ScimUser, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
