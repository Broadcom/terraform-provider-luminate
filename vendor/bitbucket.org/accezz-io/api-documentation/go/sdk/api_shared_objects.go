...
/* 
SharedObjectsApiService createSharedObject
Creates a shared object in your Secure Access Cloud tenant. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body 
 * @param optional nil or *CreateSharedObjectOpts - Optional Parameters:
     * @param "ContentType" (optional.String) -  

@return SharedObject
*/

type CreateSharedObjectOpts struct { 
	ContentType optional.String
}

func (a *SharedObjectsApiService) CreateSharedObject(ctx context.Context, body SharedObject, localVarOptionals *CreateSharedObjectOpts) (SharedObject, *http.Response, error) {
	var (
...
/* 
SharedObjectsApiService listSharedObjects
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ListSharedObjectsOpts - Optional Parameters:
...
type ListSharedObjectsOpts struct { 
...
func (a *SharedObjectsApiService) ListSharedObjects(ctx context.Context, localVarOptionals *ListSharedObjectsOpts) (SharedObject, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param sharedObjectId Shared Object ID.
 * @param body 
 * @param optional nil or *UpdateSharedObjectOpts - Optional Parameters:
     * @param "ContentType" (optional.String) -  

@return SharedObject
*/

type UpdateSharedObjectOpts struct { 
	ContentType optional.String
}

func (a *SharedObjectsApiService) UpdateSharedObject(ctx context.Context, sharedObjectId string, body SharedObject, localVarOptionals *UpdateSharedObjectOpts) (SharedObject, *http.Response, error) {
	var (
