...
type SharedObjectsApiService service
/*
SharedObjectsApiService Create Shared Object
Creates a shared object in your Secure Access Cloud tenant. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SharedObjectsApiCreateSharedObjectOpts - Optional Parameters:
     * @param "Body" (optional.Interface of PoliciesSharedobjectsBody) - 
@return SharedObject
*/

type SharedObjectsApiCreateSharedObjectOpts struct {
    Body optional.Interface
}

func (a *SharedObjectsApiService) CreateSharedObject(ctx context.Context, localVarOptionals *SharedObjectsApiCreateSharedObjectOpts) (SharedObject, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue SharedObject
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/policies/shared-objects"
...
/*
SharedObjectsApiService Delete Shared Object
Delete a shared object from your Secure Access Cloud tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param sharedObjectId Shared Object ID.

*/
func (a *SharedObjectsApiService) DeleteSharedObject(ctx context.Context, sharedObjectId string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/policies/shared-objects/{shared-object-id}"
	localVarPath = strings.Replace(localVarPath, "{"+"shared-object-id"+"}", fmt.Sprintf("%v", sharedObjectId), -1)
...
/*
SharedObjectsApiService Get Shared Object
Returns the details of a Shared Object from your Secure Access Cloud tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param sharedObjectId Shared Object ID.
@return SharedObject
*/
func (a *SharedObjectsApiService) GetSharedObject(ctx context.Context, sharedObjectId string) (SharedObject, *http.Response, error) {
	var (
...
/*
SharedObjectsApiService List Shared Objects
Return an array of paginated JSON objects. Each object represents a shared object configured in your Secure Access Cloud tenant. &lt;br&gt; The supported sort keys are either ‘name’ for sorting by shared object name or ‘created_at’/&#x27;modified_on&#x27; for sorting by date&lt;br&gt; Filter applies for the shared object name only. &lt;br&gt; Using the query filter&#x3D;test will return all the shared objects for which one or more of the above listed fields contain \&quot;test\&quot; 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SharedObjectsApiListSharedObjectsOpts - Optional Parameters:
...
type SharedObjectsApiListSharedObjectsOpts struct {
...
func (a *SharedObjectsApiService) ListSharedObjects(ctx context.Context, localVarOptionals *SharedObjectsApiListSharedObjectsOpts) (SharedObject, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
SharedObjectsApiService Update Shared Object
Update an existing shared object in your Secure Access Cloud tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param sharedObjectId Shared Object ID.
 * @param optional nil or *SharedObjectsApiUpdateSharedObjectOpts - Optional Parameters:
     * @param "Body" (optional.Interface of SharedobjectsSharedobjectidBody) - 
@return SharedObject
*/

type SharedObjectsApiUpdateSharedObjectOpts struct {
    Body optional.Interface
}

func (a *SharedObjectsApiService) UpdateSharedObject(ctx context.Context, sharedObjectId string, localVarOptionals *SharedObjectsApiUpdateSharedObjectOpts) (SharedObject, *http.Response, error) {
	var (
