 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param cloudIntegrationId Cloud Integration ID
 * @param optional nil or *CloudIntegrationApiUpdateCloudIntegrationOpts - Optional Parameters:
     * @param "Body" (optional.Interface of IntegrationsCloudintegrationidBody) -
@return CloudIntegration
*/

type CloudIntegrationApiUpdateCloudIntegrationOpts struct {
	Body optional.Interface
}

func (a *CloudIntegrationApiService) UpdateCloudIntegration(ctx context.Context, cloudIntegrationId string, localVarOptionals *CloudIntegrationApiUpdateCloudIntegrationOpts) (CloudIntegration, *http.Response, error) {
	var (
