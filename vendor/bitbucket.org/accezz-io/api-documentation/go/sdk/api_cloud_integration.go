...
*/
func (a *CloudIntegrationApiService) CreateCloudIntegration(ctx context.Context, body CloudIntegrationPost) (CloudIntegration, *http.Response, error) {
	var (
...
@return CloudIntegration
*/
func (a *CloudIntegrationApiService) UpdateCloudIntegration(ctx context.Context, cloudIntegrationId string, body CloudIntegrationPut) (CloudIntegration, *http.Response, error) {
	var (
