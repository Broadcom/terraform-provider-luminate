...
Delete a policy from your Luminate tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param policyId Policy ID.


*/
func (a *PoliciesApiService) V2PoliciesByPolicyIdDelete(ctx context.Context, policyId string) (*http.Response, error) {
	var (
...
Returns the details of a Policy from your Luminate tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param policyId Policy ID.

@return PolicyAccess
*/
func (a *PoliciesApiService) V2PoliciesByPolicyIdGet(ctx context.Context, policyId string) (PolicyAccess, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue PolicyAccess
	)
...
Update an existing policy in your Luminate tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param policyId Policy ID.
 * @param body
...
@return PolicyAccess
*/
func (a *PoliciesApiService) V2PoliciesByPolicyIdPut(ctx context.Context, policyId string, body interface{}) (PolicyAccess, *http.Response, error) {
	var (
...
/*
PoliciesApiService getSupportedActions
...
*/
func (a *PoliciesApiService) V2PoliciesConfigActionTypesGet(ctx context.Context) ([]PolicyActionType, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
PoliciesApiService getSupportedConditions
...
*/
func (a *PoliciesApiService) V2PoliciesConfigConditionDefinitionsGet(ctx context.Context) (PolicyConditionDefinition, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
PoliciesApiService getSupportedValidators
...
*/
func (a *PoliciesApiService) V2PoliciesConfigValidatorTypesGet(ctx context.Context) ([]PolicyValidatorType, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
PoliciesApiService getAllPolicies
Return an array of paginated JSON objects. Each object represents a policy configured in your Luminate tenant. &lt;br&gt; The supported sort keys are either ‘name’ for sorting by policy name or ‘id’ for sorting by policy id.&lt;br&gt; Filter applies for the policy name only. &lt;br&gt; Using the query filter&#x3D;testpolicy will return all the policies for which one or more of the above listed fields contain \&quot;testpolicy\&quot;
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *V2PoliciesGetOpts - Optional Parameters:
...
func (a *PoliciesApiService) V2PoliciesGet(ctx context.Context, localVarOptionals *V2PoliciesGetOpts) (PoliciesPage, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
PoliciesApiService createPolicy
Creates an Access / Activity Policy in your Luminate tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body

@return PolicyAccess
*/
func (a *PoliciesApiService) V2PoliciesPost(ctx context.Context, body interface{}) (PolicyAccess, *http.Response, error) {
	var (
