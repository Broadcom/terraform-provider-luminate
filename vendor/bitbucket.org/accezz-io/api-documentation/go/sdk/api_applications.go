...
Delete an application from your Luminate tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param applicationId Application ID.


*/
func (a *ApplicationsApiService) ApplicationsByApplicationIdDelete(ctx context.Context, applicationId string) (*http.Response, error) {
	var (
...
Returns the details of an Application from your Luminate tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param applicationId Application ID.

@return Application
*/
func (a *ApplicationsApiService) ApplicationsByApplicationIdGet(ctx context.Context, applicationId string) (Application, *http.Response, error) {
	var (
...
Update an existing application in your Luminate tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param applicationId Application ID.
 * @param optional nil or *ApplicationsByApplicationIdPutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) -

@return Application
*/

type ApplicationsByApplicationIdPutOpts struct {
	Body optional.Interface
}

func (a *ApplicationsApiService) ApplicationsByApplicationIdPut(ctx context.Context, applicationId string, localVarOptionals *ApplicationsByApplicationIdPutOpts) (Application, *http.Response, error) {
	var (
...
func (a *ApplicationsApiService) ApplicationsGet(ctx context.Context, localVarOptionals *ApplicationsGetOpts) (ApplicationsPage, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
Creates an application in your Luminate tenant.  **Note:** To allow access to a newly created application, you should have a Site defined and Luminate Connectors deployed. You can then assign the application to the required site using  &lt;a href&#x3D;\&quot;#operation/BindApplicationToSite\&quot;&gt;Bind Application to Site API&lt;/a&gt;.  and define access permissions using &lt;a href&#x3D;\&quot;#operation/UpdateAccessPolicyMultipleAssignments\&quot;&gt;Set/Update Access Policy API&lt;/a&gt;.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *ApplicationsApiService) ApplicationsPost(ctx context.Context, localVarOptionals *ApplicationsPostOpts) (Application, *http.Response, error) {
	var (
...
/*
ApplicationsApiService Delete Application-Site Binding.
Delete Application-Site Binding.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param applicationId Application ID.
...
*/
func (a *ApplicationsApiService) ApplicationsSiteBindingByApplicationIdAndSiteIdDelete(ctx context.Context, applicationId string, siteId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
Bind your Application to an existing Site in your Luminate tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param applicationId Application ID.
 * @param siteId Site ID.
...
*/
func (a *ApplicationsApiService) ApplicationsSiteBindingByApplicationIdAndSiteIdPut(ctx context.Context, applicationId string, siteId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
Returns the health status of the given Application from your Luminate tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param applicationId Application ID.

@return ApplicationHealth
*/
func (a *ApplicationsApiService) ApplicationsStatusByApplicationIdGet(ctx context.Context, applicationId string) (ApplicationHealth, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
