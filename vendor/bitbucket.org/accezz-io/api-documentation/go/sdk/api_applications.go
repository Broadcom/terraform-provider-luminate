...
Creates an application in your Secure Access Cloud tenant.  **Note:** To allow access to a newly created application, you should have a Site defined and Secure Access Cloud Connectors deployed. You can then assign the application to the required site using  &lt;a href&#x3D;\&quot;#operation/BindApplicationToSite\&quot;&gt;Bind Application to Site API&lt;/a&gt;.  and define access permissions using one of the below options: 1. Application Authorization model (legacy)  &lt;a href&#x3D;\&quot;#operation/UpdateApplicationAuthorizationMultipleAssignments\&quot;&gt;Set/Update Access Policy API&lt;/a&gt;. 2. Access Policy (preview) &lt;a href&#x3D;\&quot;#operation/createPolicy\&quot;&gt;Create Policy API&lt;/a&gt;. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
*/
func (a *ApplicationsApiService) DeleteApplicationSiteBinding_(ctx context.Context, applicationId string, siteId string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
