 ...
 * @param optional nil or *ApplicationsApiBindApplicationToSiteOpts - Optional Parameters:
     * @param "Body" (optional.Interface of SitebindingSiteidBody) -

*/

type ApplicationsApiBindApplicationToSiteOpts struct {
	Body optional.Interface
}

func (a *ApplicationsApiService) BindApplicationToSite(ctx context.Context, applicationId string, siteId string, localVarOptionals *ApplicationsApiBindApplicationToSiteOpts) (*http.Response, error) {
	var (
...
func (a *ApplicationsApiService) CreateApplication(ctx context.Context, localVarOptionals *ApplicationsApiCreateApplicationOpts) (Application, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ApplicationsApiGetAllAppsOpts - Optional Parameters:
...
type ApplicationsApiGetAllAppsOpts struct {
...
func (a *ApplicationsApiService) GetAllApps(ctx context.Context, localVarOptionals *ApplicationsApiGetAllAppsOpts) (ApplicationsPage, *http.Response, error) {
	var (
...
*/
func (a *ApplicationsApiService) GetApplicationHealth(ctx context.Context, applicationId string) (ApplicationHealth, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param applicationId Application ID.
 * @param optional nil or *ApplicationsApiUpdateApplicationOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ApplicationsApplicationidBody) -
@return Application
*/

type ApplicationsApiUpdateApplicationOpts struct {
	Body optional.Interface
}

func (a *ApplicationsApiService) UpdateApplication(ctx context.Context, applicationId string, localVarOptionals *ApplicationsApiUpdateApplicationOpts) (Application, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
