...
/* 
SSHClientsApiService getAllSshClients
 ...
 * @param optional nil or *GetAllSshClientsOpts - Optional Parameters:
...
type GetAllSshClientsOpts struct { 
...
func (a *SSHClientsApiService) GetAllSshClients(ctx context.Context, localVarOptionals *GetAllSshClientsOpts) (SshClientsPage, *http.Response, error) {
	var (
