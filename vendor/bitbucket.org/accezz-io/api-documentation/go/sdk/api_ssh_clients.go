...
type SSHClientsApiService service
/*
SSHClientsApiService List SSH Clients
Return an array of paginated JSON objects. Each object represents a ssh-client configured in your Secure Access Cloud tenant. &lt;br&gt; Using the query filter&#x3D;test will return all the ssh-clients for which one or more of the above listed fields contain \&quot;test\&quot; 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SSHClientsApiGetAllSshClientsOpts - Optional Parameters:
     * @param "Sort" (optional.String) -  Name of field to sort
...
@return SshClientsPage
*/

type SSHClientsApiGetAllSshClientsOpts struct {
...
func (a *SSHClientsApiService) GetAllSshClients(ctx context.Context, localVarOptionals *SSHClientsApiGetAllSshClientsOpts) (SshClientsPage, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue SshClientsPage
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ssh-clients"
