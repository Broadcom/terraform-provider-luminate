...
type ApplicationsAuthorizationLegacyApiService service

/* 
ApplicationsAuthorizationLegacyApiService getApplicationAuthorization
Returns an array of JSON objects. Each object represents Directory Entity Binding. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param applicationId Application ID.
 * @param optional nil or *GetApplicationAuthorizationOpts - Optional Parameters:
...
@return []DirectoryEntityBinding
*/

type GetApplicationAuthorizationOpts struct { 
...
func (a *ApplicationsAuthorizationLegacyApiService) GetApplicationAuthorization(ctx context.Context, applicationId string, localVarOptionals *GetApplicationAuthorizationOpts) ([]DirectoryEntityBinding, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue []DirectoryEntityBinding
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/applications/{application-id}/directory-entity-bindings"
...
/* 
ApplicationsAuthorizationLegacyApiService removeDirectoryEntityBindingByIdentifierInProviderUsingDELETE
Remove a single entry from Application Authorization configuration by IDP data. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param applicationId Application ID.
...
*/
func (a *ApplicationsAuthorizationLegacyApiService) RemoveDirectoryEntityBindingByIdentifierInProviderUsingDELETE(ctx context.Context, applicationId string, identityProviderId string, entityId string) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/applications/{application-id}/directory-entity-bindings/identity-provider-id/{identity-provider-id}/identifier-in-provider/{entity-id}"
	localVarPath = strings.Replace(localVarPath, "{"+"application-id"+"}", fmt.Sprintf("%v", applicationId), -1)
...
/* 
ApplicationsAuthorizationLegacyApiService RemoveEntriesApplicationAuthorization
Reomove existing application authorization configuration of a given application.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param applicationId Application ID.
 * @param body 
...
@return []DirectoryEntityBinding
*/
func (a *ApplicationsAuthorizationLegacyApiService) RemoveEntriesApplicationAuthorization(ctx context.Context, applicationId string, body []DirectoryEntityBinding) ([]DirectoryEntityBinding, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/applications/{application-id}/directory-entity-bindings/bulk/delete"
	localVarPath = strings.Replace(localVarPath, "{"+"application-id"+"}", fmt.Sprintf("%v", applicationId), -1)
...
/* 
ApplicationsAuthorizationLegacyApiService UpdateApplicationAuthorizationMultipleAssignments
Add or update existing Application Authorization configuration of a given application.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param applicationId Application ID.
 * @param body 
...
@return []DirectoryEntityBinding
*/
func (a *ApplicationsAuthorizationLegacyApiService) UpdateApplicationAuthorizationMultipleAssignments(ctx context.Context, applicationId string, body []DirectoryEntityBinding) ([]DirectoryEntityBinding, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/applications/{application-id}/directory-entity-bindings/bulk"
	localVarPath = strings.Replace(localVarPath, "{"+"application-id"+"}", fmt.Sprintf("%v", applicationId), -1)
