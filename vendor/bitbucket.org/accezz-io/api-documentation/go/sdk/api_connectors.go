...
func (a *ConnectorsApiService) CreateConnector(ctx context.Context, bindToSiteId string, localVarOptionals *ConnectorsApiCreateConnectorOpts) (Connector, *http.Response, error) {
	var (
