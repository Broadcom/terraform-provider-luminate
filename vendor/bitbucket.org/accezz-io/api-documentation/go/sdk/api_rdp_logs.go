 ...
 * @param body 
 * @param optional nil or *SearchRDPLogsOpts - Optional Parameters:
     * @param "ContentType" (optional.String) -  

@return RdpLogSearchResults
*/

type SearchRDPLogsOpts struct { 
	ContentType optional.String
}

func (a *RDPLogsApiService) SearchRDPLogs(ctx context.Context, body LogSearch, localVarOptionals *SearchRDPLogsOpts) (RdpLogSearchResults, *http.Response, error) {
	var (
