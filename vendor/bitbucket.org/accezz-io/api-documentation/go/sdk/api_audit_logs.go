 ...
 * @param optional nil or *LogsAuditPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of LogSearch) -

@return AuditLogSearchResults
*/

type LogsAuditPostOpts struct {
	Body optional.Interface
}

func (a *AuditLogsApiService) LogsAuditPost(ctx context.Context, localVarOptionals *LogsAuditPostOpts) (AuditLogSearchResults, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue AuditLogSearchResults
	)
