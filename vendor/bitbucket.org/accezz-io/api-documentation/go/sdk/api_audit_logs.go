 ...
 * @param body 
 * @param optional nil or *SearchAuditlogsOpts - Optional Parameters:
     * @param "ContentType" (optional.String) -  

@return AuditLogSearchResults
*/

type SearchAuditlogsOpts struct { 
	ContentType optional.String
}

func (a *AuditLogsApiService) SearchAuditlogs(ctx context.Context, body LogSearch, localVarOptionals *SearchAuditlogsOpts) (AuditLogSearchResults, *http.Response, error) {
	var (
