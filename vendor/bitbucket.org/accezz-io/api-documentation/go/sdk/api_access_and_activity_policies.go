 ...
 * @param optional nil or *AccessAndActivityPoliciesApiAssignApplicationToPoliciesOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ByappidApplicationidBody1) -

*/

type AccessAndActivityPoliciesApiAssignApplicationToPoliciesOpts struct {
	Body optional.Interface
}

func (a *AccessAndActivityPoliciesApiService) AssignApplicationToPolicies(ctx context.Context, applicationId string, localVarOptionals *AccessAndActivityPoliciesApiAssignApplicationToPoliciesOpts) (*http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *AccessAndActivityPoliciesApiCreatePolicyOpts - Optional Parameters:
     * @param "Body" (optional.Interface of PoliciesBody) -
@return Policy
*/

type AccessAndActivityPoliciesApiCreatePolicyOpts struct {
	Body optional.Interface
}

func (a *AccessAndActivityPoliciesApiService) CreatePolicy(ctx context.Context, localVarOptionals *AccessAndActivityPoliciesApiCreatePolicyOpts) (Policy, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param applicationId Application ID.
 * @param optional nil or *AccessAndActivityPoliciesApiRemoveAppByAppIDFromPoliciesOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ByappidApplicationidBody2) -

*/

type AccessAndActivityPoliciesApiRemoveAppByAppIDFromPoliciesOpts struct {
	Body optional.Interface
}

func (a *AccessAndActivityPoliciesApiService) RemoveAppByAppIDFromPolicies(ctx context.Context, applicationId string, localVarOptionals *AccessAndActivityPoliciesApiRemoveAppByAppIDFromPoliciesOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param applicationId Application ID.
 * @param optional nil or *AccessAndActivityPoliciesApiUpdateApplicationInPoliciesOpts - Optional Parameters:
     * @param "Body" (optional.Interface of ByappidApplicationidBody) -

*/

type AccessAndActivityPoliciesApiUpdateApplicationInPoliciesOpts struct {
	Body optional.Interface
}

func (a *AccessAndActivityPoliciesApiService) UpdateApplicationInPolicies(ctx context.Context, applicationId string, localVarOptionals *AccessAndActivityPoliciesApiUpdateApplicationInPoliciesOpts) (*http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param policyId Policy ID.
 * @param optional nil or *AccessAndActivityPoliciesApiUpdatePolicyOpts - Optional Parameters:
     * @param "Body" (optional.Interface of PoliciesPolicyidBody) -
@return Policy
*/

type AccessAndActivityPoliciesApiUpdatePolicyOpts struct {
	Body optional.Interface
}

func (a *AccessAndActivityPoliciesApiService) UpdatePolicy(ctx context.Context, policyId string, localVarOptionals *AccessAndActivityPoliciesApiUpdatePolicyOpts) (Policy, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
