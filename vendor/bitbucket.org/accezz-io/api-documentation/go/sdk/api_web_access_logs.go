 ...
 * @param body 
 * @param optional nil or *SearchWebAccessLogsOpts - Optional Parameters:
     * @param "ContentType" (optional.String) -  

@return AccessLogSearchResults
*/

type SearchWebAccessLogsOpts struct { 
	ContentType optional.String
}

func (a *WebAccessLogsApiService) SearchWebAccessLogs(ctx context.Context, body LogSearch, localVarOptionals *SearchWebAccessLogsOpts) (AccessLogSearchResults, *http.Response, error) {
	var (
