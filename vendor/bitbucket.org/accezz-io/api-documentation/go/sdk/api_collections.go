...
Delete Collection in your Secure Access Cloud tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *CollectionsApiService) DeleteCollection(ctx context.Context, collectionId string, localVarOptionals *CollectionsApiDeleteCollectionOpts) (*http.Response, error) {
	var (
...
Unlink Site from Collection in your Secure Access Cloud tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param collectionId The collection ID.
 * @param siteId The site ID.
 * @param optional nil or *CollectionsApiDeleteCollectionSiteLinkOpts - Optional Parameters:
     * @param "Body" (optional.Interface of CollectionidSiteidBody) -

*/

type CollectionsApiDeleteCollectionSiteLinkOpts struct {
	Body optional.Interface
}

func (a *CollectionsApiService) DeleteCollectionSiteLink(ctx context.Context, collectionId string, siteId string, localVarOptionals *CollectionsApiDeleteCollectionSiteLinkOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
Return an array of paginated JSON objects. Each object represents an collection configured in your Secure Access Cloud tenant. &lt;br&gt; Using the query filter&#x3D;testCollection will return all the collection for which one or more of the above listed fields contain \&quot;testCollection\&quot;
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
List Role Bindings in your Secure Access Cloud tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CollectionsApiListRoleBindingsOpts - Optional Parameters:
     ...
     * @param "RoleType" (optional.Interface of RoleType) -  The role type (TenantAdmin/TenantViewer/SiteEditor/SiteConnectorDeployer/ApplicationOwner/PolicyOwner/PolicyEntityAssigner) that will assign to entity.
