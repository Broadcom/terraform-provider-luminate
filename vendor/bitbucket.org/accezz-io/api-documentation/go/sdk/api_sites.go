...
Delete a site from your Luminate tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId Site ID.


*/
func (a *SitesApiService) SitesBySiteIdDelete(ctx context.Context, siteId string) (*http.Response, error) {
	var (
...
Returns the details of a Site from your Luminate tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId The Site ID.

@return Site
*/
func (a *SitesApiService) SitesBySiteIdGet(ctx context.Context, siteId string) (Site, *http.Response, error) {
	var (
...
Update an existing site in your Luminate tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId The site ID.
 * @param optional nil or *SitesBySiteIdPutOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Site) -

@return Site
*/

type SitesBySiteIdPutOpts struct {
	Body optional.Interface
}

func (a *SitesApiService) SitesBySiteIdPut(ctx context.Context, siteId string, localVarOptionals *SitesBySiteIdPutOpts) (Site, *http.Response, error) {
	var (
	...
	if localVarOptionals != nil && localVarOptionals.Body.IsSet() {
		...
		localVarOptionalBody, localVarOptionalBodyok := localVarOptionals.Body.Value().(Site)
		if !localVarOptionalBodyok {
			return localVarReturnValue, nil, reportError("body should be Site")
		}
...
func (a *SitesApiService) SitesGet(ctx context.Context, localVarOptionals *SitesGetOpts) (SitesPage, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
/*
SitesApiService createSite
Creates a Site in your Luminate tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SitesPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Site) -

@return Site
*/

type SitesPostOpts struct {
	Body optional.Interface
}

func (a *SitesApiService) SitesPost(ctx context.Context, localVarOptionals *SitesPostOpts) (Site, *http.Response, error) {
	var (
...
Returns the health status of a site from your Luminate tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId Site ID.

@return SiteStatus
*/
func (a *SitesApiService) SitesStatusBySiteIdGet(ctx context.Context, siteId string) (SiteStatus, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
