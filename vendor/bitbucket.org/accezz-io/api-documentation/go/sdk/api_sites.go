...
Creates a Site in your Secure Access Cloud tenant.
...
func (a *SitesApiService) CreateSite(ctx context.Context, localVarOptionals *SitesApiCreateSiteOpts) (Site, *http.Response, error) {
	var (
...
Delete a site from your Secure Access Cloud tenant.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param siteId Site ID.
*/
func (a *SitesApiService) DeleteSite(ctx context.Context, siteId string) (*http.Response, error) {
	var (
...
Returns the details of a Site from your Secure Access Cloud tenant.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param siteId The Site ID.

@return Site
*/
func (a *SitesApiService) GetSite(ctx context.Context, siteId string) (Site, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
Returns the health status of a site from your Secure Access Cloud tenant.
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param siteId Site ID.

@return SiteStatus
*/
func (a *SitesApiService) GetSiteStatus(ctx context.Context, siteId string) (SiteStatus, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
Update an existing site in your Secure Access Cloud tenant.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId The site ID.
 * @param optional nil or *SitesApiUpdateSiteOpts - Optional Parameters:
     * @param "Body" (optional.Interface of SitesSiteidBody) -
@return Site
*/

type SitesApiUpdateSiteOpts struct {
	Body optional.Interface
}

func (a *SitesApiService) UpdateSite(ctx context.Context, siteId string, localVarOptionals *SitesApiUpdateSiteOpts) (Site, *http.Response, error) {
	var (
