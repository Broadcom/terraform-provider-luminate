...
func (a *SitesApiService) CreateSite(ctx context.Context, localVarOptionals *CreateSiteOpts) (Site, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetAllSitesOpts - Optional Parameters:
...
func (a *SitesApiService) GetAllSites(ctx context.Context, localVarOptionals *GetAllSitesOpts) (SitesPage, *http.Response, error) {
	var (
...
@return SiteStatus
*/
func (a *SitesApiService) GetSiteHealthStatus(ctx context.Context, siteId string) (SiteStatus, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param siteId The site ID.
 * @param optional nil or *UpdateSiteOpts - Optional Parameters:
     * @param "Body" (optional.Interface of Site) -  
...
func (a *SitesApiService) UpdateSite(ctx context.Context, siteId string, localVarOptionals *UpdateSiteOpts) (Site, *http.Response, error) {
	var (
