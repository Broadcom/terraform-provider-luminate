			...
			Elem: &schema.Resource{
				Schema: map[string]*schema.Schema{
					"web_verification": {
						...
						Optional:     true,
						Default:      false,
						Description:  "Indicate whether to perform web verification validation. not compatible for HTTP applications",
						ValidateFunc: utils.ValidateBool,
					},
					"compliance_check": {
						Type:         schema.TypeBool,
						...
						Elem: &schema.Resource{
							Schema: map[string]*schema.Schema{
								"opswat": {
									...
									Optional:     true,
									Default:      false,
									Description:  "Indicate whether to restrict access according to Opswat MetaAccess",
									ValidateFunc: utils.ValidateBool,
								},
								"symantec_cloudsoc": {
									Type:         schema.TypeBool,
									Optional:     true,
									Default:      false,
									Description:  "Indicate whether to restrict according access to symantec cloudsoc",
									ValidateFunc: utils.ValidateBool,
								},
								"symantec_web_security_service": {
									...
									Optional:     true,
									Default:      false,
									Description:  "Indicate whether to restrict access to symantec web security service",
									ValidateFunc: utils.ValidateBool,
								},
							},
						},
